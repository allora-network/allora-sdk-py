#!/usr/bin/env python3
"""
Debug script to investigate TxFee to_proto issue.
"""
...
def test_txfee_to_proto():
    ...
    print("🔍 Testing TxFee.to_proto() method...")
    
    try:
        # Create a fee object like in tx_manager.py
        fee = [Coin("uallo", "1000")]
        gas_limit = 200000
        ...
        # Create TxFee object
        tx_fee = TxFee(amount=fee, gas_limit=gas_limit)
