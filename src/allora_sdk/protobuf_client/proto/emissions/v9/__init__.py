...
class InputWorkerAttributedValue(betterproto.Message):
    worker: str = betterproto.string_field(1)
    value: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class InputWithheldWorkerAttributedValue(betterproto.Message):
    worker: str = betterproto.string_field(1)
    value: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class InputOneOutInfererForecasterValues(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class InputValueBundle(betterproto.Message):
    """
    ...
    reputer_request_nonce: "_v3__.ReputerRequestNonce" = betterproto.message_field(2)
    ...
    inferer_values: List["InputWorkerAttributedValue"] = betterproto.message_field(6)
    """R_ijm || log10 L_ijm || I_ij"""

    forecaster_values: List["InputWorkerAttributedValue"] = betterproto.message_field(7)
...
@dataclass(eq=False, repr=False)
class InputReputerValueBundle(betterproto.Message):
    """
    For when the bundle is computed on a per-reputer basis (ie.. if there is an
     index `m` in the above)
    """

    value_bundle: "InputValueBundle" = betterproto.message_field(1)
    signature: bytes = betterproto.bytes_field(2)
    pubkey: str = betterproto.string_field(3)


@dataclass(eq=False, repr=False)
class InputReputerValueBundles(betterproto.Message):
    reputer_value_bundles: List["InputReputerValueBundle"] = betterproto.message_field(
        1
    )


@dataclass(eq=False, repr=False)
class InputInference(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
...
@dataclass(eq=False, repr=False)
class InputInferences(betterproto.Message):
    inferences: List["InputInference"] = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class InputForecastElement(betterproto.Message):
    inferer: str = betterproto.string_field(1)
    value: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class InputForecast(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    block_height: int = betterproto.int64_field(2)
    forecaster: str = betterproto.string_field(3)
    forecast_elements: List["InputForecastElement"] = betterproto.message_field(4)
    extra_data: bytes = betterproto.bytes_field(5)


@dataclass(eq=False, repr=False)
class InputForecasts(betterproto.Message):
    forecasts: List["InputForecast"] = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class InputInferenceForecastBundle(betterproto.Message):
    inference: "InputInference" = betterproto.message_field(1)
    forecast: "InputForecast" = betterproto.message_field(2)


@dataclass(eq=False, repr=False)
class InputWorkerDataBundle(betterproto.Message):
    worker: str = betterproto.string_field(1)
    nonce: "_v3__.Nonce" = betterproto.message_field(2)
...
@dataclass(eq=False, repr=False)
class InputWorkerDataBundles(betterproto.Message):
    worker_data_bundles: List["InputWorkerDataBundle"] = betterproto.message_field(1)
...
class OptionalParams(betterproto.Message):
    ...
    inference_outlier_detection_threshold: List[str] = betterproto.string_field(53)
    inference_outlier_detection_alpha: List[str] = betterproto.string_field(54)
    lambda_initial_score: List[str] = betterproto.string_field(55)
    global_worker_whitelist_enabled: List[bool] = betterproto.bool_field(56)
    global_reputer_whitelist_enabled: List[bool] = betterproto.bool_field(57)
    global_admin_whitelist_appended: List[bool] = betterproto.bool_field(58)
    max_whitelist_input_array_length: List[int] = betterproto.uint64_field(59)
    min_weight_threshold_for_stdnorm: List[str] = betterproto.string_field(60)
...
class InsertReputerPayloadRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    reputer_value_bundle: "InputReputerValueBundle" = betterproto.message_field(2)
...
class InsertWorkerPayloadRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    worker_data_bundle: "InputWorkerDataBundle" = betterproto.message_field(2)
...
@dataclass(eq=False, repr=False)
class AddToGlobalWorkerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    address: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class AddToGlobalWorkerWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class RemoveFromGlobalWorkerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    address: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class RemoveFromGlobalWorkerWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class AddToGlobalReputerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    address: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class AddToGlobalReputerWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class RemoveFromGlobalReputerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    address: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class RemoveFromGlobalReputerWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class AddToGlobalAdminWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    address: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class AddToGlobalAdminWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class RemoveFromGlobalAdminWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    address: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class RemoveFromGlobalAdminWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class BulkAddToGlobalWorkerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    addresses: List[str] = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class BulkAddToGlobalWorkerWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class BulkRemoveFromGlobalWorkerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    addresses: List[str] = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class BulkRemoveFromGlobalWorkerWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class BulkAddToGlobalReputerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    addresses: List[str] = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class BulkAddToGlobalReputerWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class BulkRemoveFromGlobalReputerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    addresses: List[str] = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class BulkRemoveFromGlobalReputerWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class BulkAddToTopicWorkerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    addresses: List[str] = betterproto.string_field(2)
    topic_id: int = betterproto.uint64_field(3)
...
@dataclass(eq=False, repr=False)
class BulkAddToTopicWorkerWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class BulkRemoveFromTopicWorkerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    addresses: List[str] = betterproto.string_field(2)
    topic_id: int = betterproto.uint64_field(3)
...
@dataclass(eq=False, repr=False)
class BulkRemoveFromTopicWorkerWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class BulkAddToTopicReputerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    addresses: List[str] = betterproto.string_field(2)
    topic_id: int = betterproto.uint64_field(3)
...
@dataclass(eq=False, repr=False)
class BulkAddToTopicReputerWhitelistResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class BulkRemoveFromTopicReputerWhitelistRequest(betterproto.Message):
    sender: str = betterproto.string_field(1)
    addresses: List[str] = betterproto.string_field(2)
    topic_id: int = betterproto.uint64_field(3)
...
@dataclass(eq=False, repr=False)
class BulkRemoveFromTopicReputerWhitelistResponse(betterproto.Message):
    pass
...
class EventRewardsSettled(betterproto.Message):
    ...
    block_height_tx: int = betterproto.int64_field(6)
...
@dataclass(eq=False, repr=False)
class EventNetworkInferences(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    block_height: int = betterproto.int64_field(2)
    value_bundle: "_v3__.ValueBundle" = betterproto.message_field(3)
...
@dataclass(eq=False, repr=False)
class EventListeningCoefficientsSet(betterproto.Message):
    actor_type: "ActorType" = betterproto.enum_field(1)
    topic_id: int = betterproto.uint64_field(2)
    block_height: int = betterproto.int64_field(3)
    addresses: List[str] = betterproto.string_field(4)
    coefficients: List[str] = betterproto.string_field(5)


@dataclass(eq=False, repr=False)
class EventInfererNetworkRegretSet(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    block_height: int = betterproto.int64_field(2)
    addresses: List[str] = betterproto.string_field(3)
    regrets: List[str] = betterproto.string_field(4)


@dataclass(eq=False, repr=False)
class EventForecasterNetworkRegretSet(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    block_height: int = betterproto.int64_field(2)
    addresses: List[str] = betterproto.string_field(3)
    regrets: List[str] = betterproto.string_field(4)
...
@dataclass(eq=False, repr=False)
class EventNaiveInfererNetworkRegretSet(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    block_height: int = betterproto.int64_field(2)
    addresses: List[str] = betterproto.string_field(3)
    regrets: List[str] = betterproto.string_field(4)
...
@dataclass(eq=False, repr=False)
class EventTopicInitialRegretSet(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    block_height: int = betterproto.int64_field(2)
    regret: str = betterproto.string_field(3)


@dataclass(eq=False, repr=False)
class EventTopicInitialEmaScoreSet(betterproto.Message):
    actor_type: "ActorType" = betterproto.enum_field(1)
    topic_id: int = betterproto.uint64_field(2)
    block_height: int = betterproto.int64_field(3)
...
@dataclass(eq=False, repr=False)
class EventRegretStdNormSet(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    block_height: int = betterproto.int64_field(2)
    stdnorm: str = betterproto.string_field(3)


@dataclass(eq=False, repr=False)
class EventInfererWeightSet(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    block_height: int = betterproto.int64_field(2)
...
@dataclass(eq=False, repr=False)
class EventForecasterWeightSet(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    block_height: int = betterproto.int64_field(2)
    address: str = betterproto.string_field(3)
    weight: str = betterproto.string_field(4)
...
@dataclass(eq=False, repr=False)
class EventPreviousPercentageRewardToStakedReputersSet(betterproto.Message):
    block_height: int = betterproto.int64_field(1)
    percentage: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class EventPruneRecords(betterproto.Message):
    block_height: int = betterproto.int64_field(1)
    topic_id: int = betterproto.uint64_field(2)


@dataclass(eq=False, repr=False)
class IsWhitelistedGlobalWorkerRequest(betterproto.Message):
    address: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class IsWhitelistedGlobalWorkerResponse(betterproto.Message):
    is_whitelisted_global_worker: bool = betterproto.bool_field(1)


@dataclass(eq=False, repr=False)
class IsWhitelistedGlobalReputerRequest(betterproto.Message):
    address: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class IsWhitelistedGlobalReputerResponse(betterproto.Message):
    is_whitelisted_global_reputer: bool = betterproto.bool_field(1)


@dataclass(eq=False, repr=False)
class IsWhitelistedGlobalAdminRequest(betterproto.Message):
    address: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class IsWhitelistedGlobalAdminResponse(betterproto.Message):
    is_whitelisted_global_admin: bool = betterproto.bool_field(1)
...
@dataclass(eq=False, repr=False)
class CanUpdateAllGlobalWhitelistsRequest(betterproto.Message):
    address: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class CanUpdateAllGlobalWhitelistsResponse(betterproto.Message):
    can_update_all_global_whitelists: bool = betterproto.bool_field(1)


@dataclass(eq=False, repr=False)
class CanUpdateGlobalWorkerWhitelistRequest(betterproto.Message):
    address: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class CanUpdateGlobalWorkerWhitelistResponse(betterproto.Message):
    can_update_global_worker_whitelist: bool = betterproto.bool_field(1)


@dataclass(eq=False, repr=False)
class CanUpdateGlobalReputerWhitelistRequest(betterproto.Message):
    address: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class CanUpdateGlobalReputerWhitelistResponse(betterproto.Message):
    can_update_global_reputer_whitelist: bool = betterproto.bool_field(1)
...
class GetParamsResponse(betterproto.Message):
    ...
    params: "_v8__.Params" = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class GetNetworkInferencesAtBlockOutlierResistantRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    block_height_last_inference: int = betterproto.int64_field(2)
...
@dataclass(eq=False, repr=False)
class GetLatestNetworkInferencesOutlierResistantRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
...
@dataclass(eq=False, repr=False)
class GetNetworkInferencesAtBlockOutlierResistantResponse(betterproto.Message):
    network_inferences: "_v3__.ValueBundle" = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class GetLatestNetworkInferencesOutlierResistantResponse(betterproto.Message):
    network_inferences: "_v3__.ValueBundle" = betterproto.message_field(1)
    inference_block_height: int = betterproto.int64_field(5)
...
@dataclass(eq=False, repr=False)
class GetTopicInitialInfererEmaScoreRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class GetTopicInitialInfererEmaScoreResponse(betterproto.Message):
    score: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class GetTopicInitialForecasterEmaScoreRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class GetTopicInitialForecasterEmaScoreResponse(betterproto.Message):
    score: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class GetTopicInitialReputerEmaScoreRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class GetTopicInitialReputerEmaScoreResponse(betterproto.Message):
    score: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class GetLatestRegretStdNormRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class GetLatestRegretStdNormResponse(betterproto.Message):
    value: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class GetLatestInfererWeightRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    actor_id: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class GetLatestInfererWeightResponse(betterproto.Message):
    weight: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class GetLatestForecasterWeightRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    actor_id: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class GetLatestForecasterWeightResponse(betterproto.Message):
    weight: str = betterproto.string_field(1)
...
class GenesisState(betterproto.Message):
    ...
    last_median_inferences: List["TopicIdAndDec"] = betterproto.message_field(84)
    mad_inferences: List["TopicIdAndDec"] = betterproto.message_field(85)
    initial_inferer_ema_score: List["TopicIdAndDec"] = betterproto.message_field(86)
    """
    current inferer ema scores to apply per topic
     map of topic -> inferer ema score
    """

    initial_forecaster_ema_score: List["TopicIdAndDec"] = betterproto.message_field(87)
    """
    current forecaster ema scores to apply per topic
     map of topic -> forecaster ema score
    """

    initial_reputer_ema_score: List["TopicIdAndDec"] = betterproto.message_field(88)
    """
    current reputer ema scores to apply per topic
     map of topic -> reputer ema score
    """

    global_worker_whitelist: List[str] = betterproto.string_field(89)
    global_reputer_whitelist: List[str] = betterproto.string_field(90)
    global_admin_whitelist: List[str] = betterproto.string_field(91)
    latest_regret_std_norm: List["TopicIdAndDec"] = betterproto.message_field(92)
    """REGRET STDNORM"""

    latest_inferer_weights: List["TopicIdActorIdDec"] = betterproto.message_field(93)
    """WEIGHTS"""

    latest_forecaster_weights: List["TopicIdActorIdDec"] = betterproto.message_field(94)
    network_inferences: List["TopicIdBlockHeightValueBundles"] = (
        betterproto.message_field(95)
    )
    """NETWORK INFERENCES"""
    ...
    monthly_reputer_rewards: str = betterproto.string_field(97)
    """MONTHLY REWARDS"""

    monthly_topic_rewards: str = betterproto.string_field(98)
...
class MsgServiceStub(betterproto.ServiceStub):
    ...
    async def add_to_global_worker_whitelist(
        self,
        add_to_global_worker_whitelist_request: "AddToGlobalWorkerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            add_to_global_worker_whitelist_request,
            AddToGlobalWorkerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def remove_from_global_worker_whitelist(
        self,
        remove_from_global_worker_whitelist_request: "RemoveFromGlobalWorkerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            remove_from_global_worker_whitelist_request,
            RemoveFromGlobalWorkerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def add_to_global_reputer_whitelist(
        self,
        add_to_global_reputer_whitelist_request: "AddToGlobalReputerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            add_to_global_reputer_whitelist_request,
            AddToGlobalReputerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def remove_from_global_reputer_whitelist(
        self,
        remove_from_global_reputer_whitelist_request: "RemoveFromGlobalReputerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            remove_from_global_reputer_whitelist_request,
            RemoveFromGlobalReputerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def add_to_global_admin_whitelist(
        self,
        add_to_global_admin_whitelist_request: "AddToGlobalAdminWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            add_to_global_admin_whitelist_request,
            AddToGlobalAdminWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def remove_from_global_admin_whitelist(
        self,
        remove_from_global_admin_whitelist_request: "RemoveFromGlobalAdminWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            remove_from_global_admin_whitelist_request,
            RemoveFromGlobalAdminWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def bulk_add_to_global_worker_whitelist(
        self,
        bulk_add_to_global_worker_whitelist_request: "BulkAddToGlobalWorkerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            bulk_add_to_global_worker_whitelist_request,
            BulkAddToGlobalWorkerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def bulk_remove_from_global_worker_whitelist(
        self,
        bulk_remove_from_global_worker_whitelist_request: "BulkRemoveFromGlobalWorkerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            bulk_remove_from_global_worker_whitelist_request,
            BulkRemoveFromGlobalWorkerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def bulk_add_to_global_reputer_whitelist(
        self,
        bulk_add_to_global_reputer_whitelist_request: "BulkAddToGlobalReputerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            bulk_add_to_global_reputer_whitelist_request,
            BulkAddToGlobalReputerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def bulk_remove_from_global_reputer_whitelist(
        self,
        bulk_remove_from_global_reputer_whitelist_request: "BulkRemoveFromGlobalReputerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            bulk_remove_from_global_reputer_whitelist_request,
            BulkRemoveFromGlobalReputerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def bulk_add_to_topic_worker_whitelist(
        self,
        bulk_add_to_topic_worker_whitelist_request: "BulkAddToTopicWorkerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            bulk_add_to_topic_worker_whitelist_request,
            BulkAddToTopicWorkerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def bulk_remove_from_topic_worker_whitelist(
        self,
        bulk_remove_from_topic_worker_whitelist_request: "BulkRemoveFromTopicWorkerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            bulk_remove_from_topic_worker_whitelist_request,
            BulkRemoveFromTopicWorkerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def bulk_add_to_topic_reputer_whitelist(
        self,
        bulk_add_to_topic_reputer_whitelist_request: "BulkAddToTopicReputerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            bulk_add_to_topic_reputer_whitelist_request,
            BulkAddToTopicReputerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def bulk_remove_from_topic_reputer_whitelist(
        self,
        bulk_remove_from_topic_reputer_whitelist_request: "BulkRemoveFromTopicReputerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            bulk_remove_from_topic_reputer_whitelist_request,
            BulkRemoveFromTopicReputerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class QueryServiceStub(betterproto.ServiceStub):
    ...
    async def get_network_inferences_at_block_outlier_resistant(
        self,
        get_network_inferences_at_block_outlier_resistant_request: "GetNetworkInferencesAtBlockOutlierResistantRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            get_network_inferences_at_block_outlier_resistant_request,
            GetNetworkInferencesAtBlockOutlierResistantResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_latest_network_inferences_outlier_resistant(
        self,
        get_latest_network_inferences_outlier_resistant_request: "GetLatestNetworkInferencesOutlierResistantRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            get_latest_network_inferences_outlier_resistant_request,
            GetLatestNetworkInferencesOutlierResistantResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def is_whitelisted_global_worker(
        self,
        is_whitelisted_global_worker_request: "IsWhitelistedGlobalWorkerRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            is_whitelisted_global_worker_request,
            IsWhitelistedGlobalWorkerResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def is_whitelisted_global_reputer(
        self,
        is_whitelisted_global_reputer_request: "IsWhitelistedGlobalReputerRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            is_whitelisted_global_reputer_request,
            IsWhitelistedGlobalReputerResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def is_whitelisted_global_admin(
        self,
        is_whitelisted_global_admin_request: "IsWhitelistedGlobalAdminRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            is_whitelisted_global_admin_request,
            IsWhitelistedGlobalAdminResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def can_update_all_global_whitelists(
        self,
        can_update_all_global_whitelists_request: "CanUpdateAllGlobalWhitelistsRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            can_update_all_global_whitelists_request,
            CanUpdateAllGlobalWhitelistsResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def can_update_global_worker_whitelist(
        self,
        can_update_global_worker_whitelist_request: "CanUpdateGlobalWorkerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            can_update_global_worker_whitelist_request,
            CanUpdateGlobalWorkerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def can_update_global_reputer_whitelist(
        self,
        can_update_global_reputer_whitelist_request: "CanUpdateGlobalReputerWhitelistRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            can_update_global_reputer_whitelist_request,
            CanUpdateGlobalReputerWhitelistResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_topic_initial_inferer_ema_score(
        self,
        get_topic_initial_inferer_ema_score_request: "GetTopicInitialInfererEmaScoreRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            get_topic_initial_inferer_ema_score_request,
            GetTopicInitialInfererEmaScoreResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_topic_initial_forecaster_ema_score(
        self,
        get_topic_initial_forecaster_ema_score_request: "GetTopicInitialForecasterEmaScoreRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            get_topic_initial_forecaster_ema_score_request,
            GetTopicInitialForecasterEmaScoreResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_topic_initial_reputer_ema_score(
        self,
        get_topic_initial_reputer_ema_score_request: "GetTopicInitialReputerEmaScoreRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            get_topic_initial_reputer_ema_score_request,
            GetTopicInitialReputerEmaScoreResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_latest_regret_std_norm(
        self,
        get_latest_regret_std_norm_request: "GetLatestRegretStdNormRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            get_latest_regret_std_norm_request,
            GetLatestRegretStdNormResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_latest_inferer_weight(
        self,
        get_latest_inferer_weight_request: "GetLatestInfererWeightRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            get_latest_inferer_weight_request,
            GetLatestInfererWeightResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_latest_forecaster_weight(
        self,
        get_latest_forecaster_weight_request: "GetLatestForecasterWeightRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            get_latest_forecaster_weight_request,
            GetLatestForecasterWeightResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class MsgServiceBase(ServiceBase):
    ...
    async def add_to_global_admin_whitelist(
        self, add_to_global_admin_whitelist_request: "AddToGlobalAdminWhitelistRequest"
    ) -> "AddToGlobalAdminWhitelistResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_add_to_global_worker_whitelist(
        self,
        stream: "grpclib.server.Stream[AddToGlobalWorkerWhitelistRequest, AddToGlobalWorkerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.add_to_global_worker_whitelist(request)
        await stream.send_message(response)

    async def __rpc_remove_from_global_worker_whitelist(
        self,
        stream: "grpclib.server.Stream[RemoveFromGlobalWorkerWhitelistRequest, RemoveFromGlobalWorkerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.remove_from_global_worker_whitelist(request)
        await stream.send_message(response)

    async def __rpc_add_to_global_reputer_whitelist(
        self,
        stream: "grpclib.server.Stream[AddToGlobalReputerWhitelistRequest, AddToGlobalReputerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.add_to_global_reputer_whitelist(request)
        await stream.send_message(response)

    async def __rpc_remove_from_global_reputer_whitelist(
        self,
        stream: "grpclib.server.Stream[RemoveFromGlobalReputerWhitelistRequest, RemoveFromGlobalReputerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.remove_from_global_reputer_whitelist(request)
        await stream.send_message(response)

    async def __rpc_add_to_global_admin_whitelist(
        self,
        stream: "grpclib.server.Stream[AddToGlobalAdminWhitelistRequest, AddToGlobalAdminWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.add_to_global_admin_whitelist(request)
        await stream.send_message(response)

    async def __rpc_remove_from_global_admin_whitelist(
        self,
        stream: "grpclib.server.Stream[RemoveFromGlobalAdminWhitelistRequest, RemoveFromGlobalAdminWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.remove_from_global_admin_whitelist(request)
        await stream.send_message(response)

    async def __rpc_bulk_add_to_global_worker_whitelist(
        self,
        stream: "grpclib.server.Stream[BulkAddToGlobalWorkerWhitelistRequest, BulkAddToGlobalWorkerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.bulk_add_to_global_worker_whitelist(request)
        await stream.send_message(response)

    async def __rpc_bulk_remove_from_global_worker_whitelist(
        self,
        stream: "grpclib.server.Stream[BulkRemoveFromGlobalWorkerWhitelistRequest, BulkRemoveFromGlobalWorkerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.bulk_remove_from_global_worker_whitelist(request)
        await stream.send_message(response)

    async def __rpc_bulk_add_to_global_reputer_whitelist(
        self,
        stream: "grpclib.server.Stream[BulkAddToGlobalReputerWhitelistRequest, BulkAddToGlobalReputerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.bulk_add_to_global_reputer_whitelist(request)
        await stream.send_message(response)

    async def __rpc_bulk_remove_from_global_reputer_whitelist(
        self,
        stream: "grpclib.server.Stream[BulkRemoveFromGlobalReputerWhitelistRequest, BulkRemoveFromGlobalReputerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.bulk_remove_from_global_reputer_whitelist(request)
        await stream.send_message(response)

    async def __rpc_bulk_add_to_topic_worker_whitelist(
        self,
        stream: "grpclib.server.Stream[BulkAddToTopicWorkerWhitelistRequest, BulkAddToTopicWorkerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.bulk_add_to_topic_worker_whitelist(request)
        await stream.send_message(response)

    async def __rpc_bulk_remove_from_topic_worker_whitelist(
        self,
        stream: "grpclib.server.Stream[BulkRemoveFromTopicWorkerWhitelistRequest, BulkRemoveFromTopicWorkerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.bulk_remove_from_topic_worker_whitelist(request)
        await stream.send_message(response)

    async def __rpc_bulk_add_to_topic_reputer_whitelist(
        self,
        stream: "grpclib.server.Stream[BulkAddToTopicReputerWhitelistRequest, BulkAddToTopicReputerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.bulk_add_to_topic_reputer_whitelist(request)
        await stream.send_message(response)

    async def __rpc_bulk_remove_from_topic_reputer_whitelist(
        self,
        stream: "grpclib.server.Stream[BulkRemoveFromTopicReputerWhitelistRequest, BulkRemoveFromTopicReputerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.bulk_remove_from_topic_reputer_whitelist(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/emissions.v9.MsgService/UpdateParams": grpclib.const.Handler(
                self.__rpc_update_params,
                grpclib.const.Cardinality.UNARY_UNARY,
                UpdateParamsRequest,
                UpdateParamsResponse,
            ),
            "/emissions.v9.MsgService/CreateNewTopic": grpclib.const.Handler(
                self.__rpc_create_new_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                CreateNewTopicRequest,
                CreateNewTopicResponse,
            ),
            "/emissions.v9.MsgService/Register": grpclib.const.Handler(
                self.__rpc_register,
                grpclib.const.Cardinality.UNARY_UNARY,
                RegisterRequest,
                RegisterResponse,
            ),
            "/emissions.v9.MsgService/RemoveRegistration": grpclib.const.Handler(
                self.__rpc_remove_registration,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveRegistrationRequest,
                RemoveRegistrationResponse,
            ),
            "/emissions.v9.MsgService/AddStake": grpclib.const.Handler(
                self.__rpc_add_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddStakeRequest,
                AddStakeResponse,
            ),
            "/emissions.v9.MsgService/RemoveStake": grpclib.const.Handler(
                self.__rpc_remove_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveStakeRequest,
                RemoveStakeResponse,
            ),
            "/emissions.v9.MsgService/CancelRemoveStake": grpclib.const.Handler(
                self.__rpc_cancel_remove_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                CancelRemoveStakeRequest,
                CancelRemoveStakeResponse,
            ),
            "/emissions.v9.MsgService/DelegateStake": grpclib.const.Handler(
                self.__rpc_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                DelegateStakeRequest,
                DelegateStakeResponse,
            ),
            "/emissions.v9.MsgService/RewardDelegateStake": grpclib.const.Handler(
                self.__rpc_reward_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                RewardDelegateStakeRequest,
                RewardDelegateStakeResponse,
            ),
            "/emissions.v9.MsgService/RemoveDelegateStake": grpclib.const.Handler(
                self.__rpc_remove_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveDelegateStakeRequest,
                RemoveDelegateStakeResponse,
            ),
            "/emissions.v9.MsgService/CancelRemoveDelegateStake": grpclib.const.Handler(
                self.__rpc_cancel_remove_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                CancelRemoveDelegateStakeRequest,
                CancelRemoveDelegateStakeResponse,
            ),
            "/emissions.v9.MsgService/FundTopic": grpclib.const.Handler(
                self.__rpc_fund_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                FundTopicRequest,
                FundTopicResponse,
            ),
            "/emissions.v9.MsgService/AddToWhitelistAdmin": grpclib.const.Handler(
                self.__rpc_add_to_whitelist_admin,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToWhitelistAdminRequest,
                AddToWhitelistAdminResponse,
            ),
            "/emissions.v9.MsgService/RemoveFromWhitelistAdmin": grpclib.const.Handler(
                self.__rpc_remove_from_whitelist_admin,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromWhitelistAdminRequest,
                RemoveFromWhitelistAdminResponse,
            ),
            "/emissions.v9.MsgService/InsertWorkerPayload": grpclib.const.Handler(
                self.__rpc_insert_worker_payload,
                grpclib.const.Cardinality.UNARY_UNARY,
                InsertWorkerPayloadRequest,
                InsertWorkerPayloadResponse,
            ),
            "/emissions.v9.MsgService/InsertReputerPayload": grpclib.const.Handler(
                self.__rpc_insert_reputer_payload,
                grpclib.const.Cardinality.UNARY_UNARY,
                InsertReputerPayloadRequest,
                InsertReputerPayloadResponse,
            ),
            "/emissions.v9.MsgService/AddToGlobalWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_global_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToGlobalWhitelistRequest,
                AddToGlobalWhitelistResponse,
            ),
            "/emissions.v9.MsgService/RemoveFromGlobalWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_global_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromGlobalWhitelistRequest,
                RemoveFromGlobalWhitelistResponse,
            ),
            "/emissions.v9.MsgService/AddToGlobalWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_global_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToGlobalWorkerWhitelistRequest,
                AddToGlobalWorkerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/RemoveFromGlobalWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_global_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromGlobalWorkerWhitelistRequest,
                RemoveFromGlobalWorkerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/AddToGlobalReputerWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_global_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToGlobalReputerWhitelistRequest,
                AddToGlobalReputerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/RemoveFromGlobalReputerWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_global_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromGlobalReputerWhitelistRequest,
                RemoveFromGlobalReputerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/AddToGlobalAdminWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_global_admin_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToGlobalAdminWhitelistRequest,
                AddToGlobalAdminWhitelistResponse,
            ),
            "/emissions.v9.MsgService/RemoveFromGlobalAdminWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_global_admin_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromGlobalAdminWhitelistRequest,
                RemoveFromGlobalAdminWhitelistResponse,
            ),
            "/emissions.v9.MsgService/BulkAddToGlobalWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_add_to_global_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkAddToGlobalWorkerWhitelistRequest,
                BulkAddToGlobalWorkerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/BulkRemoveFromGlobalWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_remove_from_global_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkRemoveFromGlobalWorkerWhitelistRequest,
                BulkRemoveFromGlobalWorkerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/BulkAddToGlobalReputerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_add_to_global_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkAddToGlobalReputerWhitelistRequest,
                BulkAddToGlobalReputerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/BulkRemoveFromGlobalReputerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_remove_from_global_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkRemoveFromGlobalReputerWhitelistRequest,
                BulkRemoveFromGlobalReputerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/BulkAddToTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_add_to_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkAddToTopicWorkerWhitelistRequest,
                BulkAddToTopicWorkerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/BulkRemoveFromTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_remove_from_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkRemoveFromTopicWorkerWhitelistRequest,
                BulkRemoveFromTopicWorkerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/BulkAddToTopicReputerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_add_to_topic_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkAddToTopicReputerWhitelistRequest,
                BulkAddToTopicReputerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/BulkRemoveFromTopicReputerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_remove_from_topic_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkRemoveFromTopicReputerWhitelistRequest,
                BulkRemoveFromTopicReputerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/EnableTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_enable_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                EnableTopicWorkerWhitelistRequest,
                EnableTopicWorkerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/DisableTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_disable_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                DisableTopicWorkerWhitelistRequest,
                DisableTopicWorkerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/EnableTopicReputerWhitelist": grpclib.const.Handler(
                self.__rpc_enable_topic_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                EnableTopicReputerWhitelistRequest,
                EnableTopicReputerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/DisableTopicReputerWhitelist": grpclib.const.Handler(
                self.__rpc_disable_topic_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                DisableTopicReputerWhitelistRequest,
                DisableTopicReputerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/AddToTopicCreatorWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_topic_creator_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToTopicCreatorWhitelistRequest,
                AddToTopicCreatorWhitelistResponse,
            ),
            "/emissions.v9.MsgService/RemoveFromTopicCreatorWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_topic_creator_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromTopicCreatorWhitelistRequest,
                RemoveFromTopicCreatorWhitelistResponse,
            ),
            "/emissions.v9.MsgService/AddToTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToTopicWorkerWhitelistRequest,
                AddToTopicWorkerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/RemoveFromTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromTopicWorkerWhitelistRequest,
                RemoveFromTopicWorkerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/AddToTopicReputerWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_topic_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToTopicReputerWhitelistRequest,
                AddToTopicReputerWhitelistResponse,
            ),
            "/emissions.v9.MsgService/RemoveFromTopicReputerWhitelist": grpclib.const.Handler(
...
class QueryServiceBase(ServiceBase):
    ...
    async def is_whitelisted_global_worker(
        self, is_whitelisted_global_worker_request: "IsWhitelistedGlobalWorkerRequest"
    ) -> "IsWhitelistedGlobalWorkerResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def is_whitelisted_global_reputer(
        self, is_whitelisted_global_reputer_request: "IsWhitelistedGlobalReputerRequest"
    ) -> "IsWhitelistedGlobalReputerResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def is_whitelisted_global_admin(
        self, is_whitelisted_global_admin_request: "IsWhitelistedGlobalAdminRequest"
    ) -> "IsWhitelistedGlobalAdminResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_latest_regret_std_norm(
        self, get_latest_regret_std_norm_request: "GetLatestRegretStdNormRequest"
    ) -> "GetLatestRegretStdNormResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_latest_inferer_weight(
        self, get_latest_inferer_weight_request: "GetLatestInfererWeightRequest"
    ) -> "GetLatestInfererWeightResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_latest_forecaster_weight(
        self, get_latest_forecaster_weight_request: "GetLatestForecasterWeightRequest"
    ) -> "GetLatestForecasterWeightResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_get_network_inferences_at_block_outlier_resistant(
        self,
        stream: "grpclib.server.Stream[GetNetworkInferencesAtBlockOutlierResistantRequest, GetNetworkInferencesAtBlockOutlierResistantResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_network_inferences_at_block_outlier_resistant(request)
        await stream.send_message(response)
    ...
    async def __rpc_get_latest_network_inferences_outlier_resistant(
        self,
        stream: "grpclib.server.Stream[GetLatestNetworkInferencesOutlierResistantRequest, GetLatestNetworkInferencesOutlierResistantResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_latest_network_inferences_outlier_resistant(request)
        await stream.send_message(response)
    ...
    async def __rpc_is_whitelisted_global_worker(
        self,
        stream: "grpclib.server.Stream[IsWhitelistedGlobalWorkerRequest, IsWhitelistedGlobalWorkerResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.is_whitelisted_global_worker(request)
        await stream.send_message(response)

    async def __rpc_is_whitelisted_global_reputer(
        self,
        stream: "grpclib.server.Stream[IsWhitelistedGlobalReputerRequest, IsWhitelistedGlobalReputerResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.is_whitelisted_global_reputer(request)
        await stream.send_message(response)

    async def __rpc_is_whitelisted_global_admin(
        self,
        stream: "grpclib.server.Stream[IsWhitelistedGlobalAdminRequest, IsWhitelistedGlobalAdminResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.is_whitelisted_global_admin(request)
        await stream.send_message(response)
    ...
    async def __rpc_can_update_all_global_whitelists(
        self,
        stream: "grpclib.server.Stream[CanUpdateAllGlobalWhitelistsRequest, CanUpdateAllGlobalWhitelistsResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.can_update_all_global_whitelists(request)
        await stream.send_message(response)

    async def __rpc_can_update_global_worker_whitelist(
        self,
        stream: "grpclib.server.Stream[CanUpdateGlobalWorkerWhitelistRequest, CanUpdateGlobalWorkerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.can_update_global_worker_whitelist(request)
        await stream.send_message(response)

    async def __rpc_can_update_global_reputer_whitelist(
        self,
        stream: "grpclib.server.Stream[CanUpdateGlobalReputerWhitelistRequest, CanUpdateGlobalReputerWhitelistResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.can_update_global_reputer_whitelist(request)
        await stream.send_message(response)
    ...
    async def __rpc_get_topic_initial_inferer_ema_score(
        self,
        stream: "grpclib.server.Stream[GetTopicInitialInfererEmaScoreRequest, GetTopicInitialInfererEmaScoreResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_topic_initial_inferer_ema_score(request)
        await stream.send_message(response)

    async def __rpc_get_topic_initial_forecaster_ema_score(
        self,
        stream: "grpclib.server.Stream[GetTopicInitialForecasterEmaScoreRequest, GetTopicInitialForecasterEmaScoreResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_topic_initial_forecaster_ema_score(request)
        await stream.send_message(response)

    async def __rpc_get_topic_initial_reputer_ema_score(
        self,
        stream: "grpclib.server.Stream[GetTopicInitialReputerEmaScoreRequest, GetTopicInitialReputerEmaScoreResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_topic_initial_reputer_ema_score(request)
        await stream.send_message(response)

    async def __rpc_get_latest_regret_std_norm(
        self,
        stream: "grpclib.server.Stream[GetLatestRegretStdNormRequest, GetLatestRegretStdNormResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_latest_regret_std_norm(request)
        await stream.send_message(response)

    async def __rpc_get_latest_inferer_weight(
        self,
        stream: "grpclib.server.Stream[GetLatestInfererWeightRequest, GetLatestInfererWeightResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_latest_inferer_weight(request)
        await stream.send_message(response)

    async def __rpc_get_latest_forecaster_weight(
        self,
        stream: "grpclib.server.Stream[GetLatestForecasterWeightRequest, GetLatestForecasterWeightResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_latest_forecaster_weight(request)
        await stream.send_message(response)

    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/emissions.v9.QueryService/GetParams": grpclib.const.Handler(
                self.__rpc_get_params,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetParamsRequest,
                GetParamsResponse,
            ),
            "/emissions.v9.QueryService/GetNextTopicId": grpclib.const.Handler(
                self.__rpc_get_next_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNextTopicIdRequest,
                GetNextTopicIdResponse,
            ),
            "/emissions.v9.QueryService/GetTopic": grpclib.const.Handler(
                self.__rpc_get_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicRequest,
                GetTopicResponse,
            ),
            "/emissions.v9.QueryService/GetWorkerLatestInferenceByTopicId": grpclib.const.Handler(
                self.__rpc_get_worker_latest_inference_by_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetWorkerLatestInferenceByTopicIdRequest,
                GetWorkerLatestInferenceByTopicIdResponse,
            ),
            "/emissions.v9.QueryService/GetInferencesAtBlock": grpclib.const.Handler(
                self.__rpc_get_inferences_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetInferencesAtBlockRequest,
                GetInferencesAtBlockResponse,
            ),
            "/emissions.v9.QueryService/GetLatestTopicInferences": grpclib.const.Handler(
                self.__rpc_get_latest_topic_inferences,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestTopicInferencesRequest,
                GetLatestTopicInferencesResponse,
            ),
            "/emissions.v9.QueryService/GetForecastsAtBlock": grpclib.const.Handler(
                self.__rpc_get_forecasts_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetForecastsAtBlockRequest,
                GetForecastsAtBlockResponse,
            ),
            "/emissions.v9.QueryService/GetNetworkLossBundleAtBlock": grpclib.const.Handler(
                self.__rpc_get_network_loss_bundle_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNetworkLossBundleAtBlockRequest,
                GetNetworkLossBundleAtBlockResponse,
            ),
            "/emissions.v9.QueryService/GetTotalStake": grpclib.const.Handler(
                self.__rpc_get_total_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTotalStakeRequest,
                GetTotalStakeResponse,
            ),
            "/emissions.v9.QueryService/GetReputerStakeInTopic": grpclib.const.Handler(
                self.__rpc_get_reputer_stake_in_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetReputerStakeInTopicRequest,
                GetReputerStakeInTopicResponse,
            ),
            "/emissions.v9.QueryService/GetMultiReputerStakeInTopic": grpclib.const.Handler(
                self.__rpc_get_multi_reputer_stake_in_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetMultiReputerStakeInTopicRequest,
                GetMultiReputerStakeInTopicResponse,
            ),
            "/emissions.v9.QueryService/GetStakeFromReputerInTopicInSelf": grpclib.const.Handler(
                self.__rpc_get_stake_from_reputer_in_topic_in_self,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeFromReputerInTopicInSelfRequest,
                GetStakeFromReputerInTopicInSelfResponse,
            ),
            "/emissions.v9.QueryService/GetDelegateStakeInTopicInReputer": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_in_topic_in_reputer,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakeInTopicInReputerRequest,
                GetDelegateStakeInTopicInReputerResponse,
            ),
            "/emissions.v9.QueryService/GetStakeFromDelegatorInTopicInReputer": grpclib.const.Handler(
                self.__rpc_get_stake_from_delegator_in_topic_in_reputer,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeFromDelegatorInTopicInReputerRequest,
                GetStakeFromDelegatorInTopicInReputerResponse,
            ),
            "/emissions.v9.QueryService/GetStakeFromDelegatorInTopic": grpclib.const.Handler(
                self.__rpc_get_stake_from_delegator_in_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeFromDelegatorInTopicRequest,
                GetStakeFromDelegatorInTopicResponse,
            ),
            "/emissions.v9.QueryService/GetTopicStake": grpclib.const.Handler(
                self.__rpc_get_topic_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicStakeRequest,
                GetTopicStakeResponse,
            ),
            "/emissions.v9.QueryService/GetStakeRemovalsUpUntilBlock": grpclib.const.Handler(
                self.__rpc_get_stake_removals_up_until_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeRemovalsUpUntilBlockRequest,
                GetStakeRemovalsUpUntilBlockResponse,
            ),
            "/emissions.v9.QueryService/GetDelegateStakeRemovalsUpUntilBlock": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_removals_up_until_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakeRemovalsUpUntilBlockRequest,
                GetDelegateStakeRemovalsUpUntilBlockResponse,
            ),
            "/emissions.v9.QueryService/GetStakeRemovalInfo": grpclib.const.Handler(
                self.__rpc_get_stake_removal_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeRemovalInfoRequest,
                GetStakeRemovalInfoResponse,
            ),
            "/emissions.v9.QueryService/GetDelegateStakeRemovalInfo": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_removal_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakeRemovalInfoRequest,
                GetDelegateStakeRemovalInfoResponse,
            ),
            "/emissions.v9.QueryService/GetWorkerNodeInfo": grpclib.const.Handler(
                self.__rpc_get_worker_node_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetWorkerNodeInfoRequest,
                GetWorkerNodeInfoResponse,
            ),
            "/emissions.v9.QueryService/GetReputerNodeInfo": grpclib.const.Handler(
                self.__rpc_get_reputer_node_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetReputerNodeInfoRequest,
                GetReputerNodeInfoResponse,
            ),
            "/emissions.v9.QueryService/IsWorkerRegisteredInTopicId": grpclib.const.Handler(
                self.__rpc_is_worker_registered_in_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWorkerRegisteredInTopicIdRequest,
                IsWorkerRegisteredInTopicIdResponse,
            ),
            "/emissions.v9.QueryService/IsReputerRegisteredInTopicId": grpclib.const.Handler(
                self.__rpc_is_reputer_registered_in_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsReputerRegisteredInTopicIdRequest,
                IsReputerRegisteredInTopicIdResponse,
            ),
            "/emissions.v9.QueryService/GetNetworkInferencesAtBlock": grpclib.const.Handler(
                self.__rpc_get_network_inferences_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNetworkInferencesAtBlockRequest,
                GetNetworkInferencesAtBlockResponse,
            ),
            "/emissions.v9.QueryService/GetNetworkInferencesAtBlockOutlierResistant": grpclib.const.Handler(
                self.__rpc_get_network_inferences_at_block_outlier_resistant,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNetworkInferencesAtBlockOutlierResistantRequest,
                GetNetworkInferencesAtBlockOutlierResistantResponse,
            ),
            "/emissions.v9.QueryService/GetLatestNetworkInferences": grpclib.const.Handler(
                self.__rpc_get_latest_network_inferences,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestNetworkInferencesRequest,
                GetLatestNetworkInferencesResponse,
            ),
            "/emissions.v9.QueryService/GetLatestNetworkInferencesOutlierResistant": grpclib.const.Handler(
                self.__rpc_get_latest_network_inferences_outlier_resistant,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestNetworkInferencesOutlierResistantRequest,
                GetLatestNetworkInferencesOutlierResistantResponse,
            ),
            "/emissions.v9.QueryService/IsWorkerNonceUnfulfilled": grpclib.const.Handler(
                self.__rpc_is_worker_nonce_unfulfilled,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWorkerNonceUnfulfilledRequest,
                IsWorkerNonceUnfulfilledResponse,
            ),
            "/emissions.v9.QueryService/IsReputerNonceUnfulfilled": grpclib.const.Handler(
                self.__rpc_is_reputer_nonce_unfulfilled,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsReputerNonceUnfulfilledRequest,
                IsReputerNonceUnfulfilledResponse,
            ),
            "/emissions.v9.QueryService/GetUnfulfilledWorkerNonces": grpclib.const.Handler(
                self.__rpc_get_unfulfilled_worker_nonces,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetUnfulfilledWorkerNoncesRequest,
                GetUnfulfilledWorkerNoncesResponse,
            ),
            "/emissions.v9.QueryService/GetUnfulfilledReputerNonces": grpclib.const.Handler(
                self.__rpc_get_unfulfilled_reputer_nonces,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetUnfulfilledReputerNoncesRequest,
                GetUnfulfilledReputerNoncesResponse,
            ),
            "/emissions.v9.QueryService/GetInfererNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_inferer_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetInfererNetworkRegretRequest,
                GetInfererNetworkRegretResponse,
            ),
            "/emissions.v9.QueryService/GetForecasterNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_forecaster_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetForecasterNetworkRegretRequest,
                GetForecasterNetworkRegretResponse,
            ),
            "/emissions.v9.QueryService/GetOneInForecasterNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_one_in_forecaster_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetOneInForecasterNetworkRegretRequest,
                GetOneInForecasterNetworkRegretResponse,
            ),
            "/emissions.v9.QueryService/IsWhitelistAdmin": grpclib.const.Handler(
                self.__rpc_is_whitelist_admin,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistAdminRequest,
                IsWhitelistAdminResponse,
            ),
            "/emissions.v9.QueryService/GetTopicLastWorkerCommitInfo": grpclib.const.Handler(
                self.__rpc_get_topic_last_worker_commit_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicLastWorkerCommitInfoRequest,
                GetTopicLastWorkerCommitInfoResponse,
            ),
            "/emissions.v9.QueryService/GetTopicLastReputerCommitInfo": grpclib.const.Handler(
                self.__rpc_get_topic_last_reputer_commit_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicLastReputerCommitInfoRequest,
                GetTopicLastReputerCommitInfoResponse,
            ),
            "/emissions.v9.QueryService/GetTopicRewardNonce": grpclib.const.Handler(
                self.__rpc_get_topic_reward_nonce,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicRewardNonceRequest,
                GetTopicRewardNonceResponse,
            ),
            "/emissions.v9.QueryService/GetReputerLossBundlesAtBlock": grpclib.const.Handler(
                self.__rpc_get_reputer_loss_bundles_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetReputerLossBundlesAtBlockRequest,
                GetReputerLossBundlesAtBlockResponse,
            ),
            "/emissions.v9.QueryService/GetStakeReputerAuthority": grpclib.const.Handler(
                self.__rpc_get_stake_reputer_authority,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeReputerAuthorityRequest,
                GetStakeReputerAuthorityResponse,
            ),
            "/emissions.v9.QueryService/GetDelegateStakePlacement": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_placement,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakePlacementRequest,
                GetDelegateStakePlacementResponse,
            ),
            "/emissions.v9.QueryService/GetDelegateStakeUponReputer": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_upon_reputer,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakeUponReputerRequest,
                GetDelegateStakeUponReputerResponse,
            ),
            "/emissions.v9.QueryService/GetDelegateRewardPerShare": grpclib.const.Handler(
                self.__rpc_get_delegate_reward_per_share,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateRewardPerShareRequest,
                GetDelegateRewardPerShareResponse,
            ),
            "/emissions.v9.QueryService/GetStakeRemovalForReputerAndTopicId": grpclib.const.Handler(
                self.__rpc_get_stake_removal_for_reputer_and_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeRemovalForReputerAndTopicIdRequest,
                GetStakeRemovalForReputerAndTopicIdResponse,
            ),
            "/emissions.v9.QueryService/GetDelegateStakeRemoval": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_removal,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakeRemovalRequest,
                GetDelegateStakeRemovalResponse,
            ),
            "/emissions.v9.QueryService/GetPreviousTopicWeight": grpclib.const.Handler(
                self.__rpc_get_previous_topic_weight,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousTopicWeightRequest,
                GetPreviousTopicWeightResponse,
            ),
            "/emissions.v9.QueryService/GetTotalSumPreviousTopicWeights": grpclib.const.Handler(
                self.__rpc_get_total_sum_previous_topic_weights,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTotalSumPreviousTopicWeightsRequest,
                GetTotalSumPreviousTopicWeightsResponse,
            ),
            "/emissions.v9.QueryService/TopicExists": grpclib.const.Handler(
                self.__rpc_topic_exists,
                grpclib.const.Cardinality.UNARY_UNARY,
                TopicExistsRequest,
                TopicExistsResponse,
            ),
            "/emissions.v9.QueryService/IsTopicActive": grpclib.const.Handler(
                self.__rpc_is_topic_active,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsTopicActiveRequest,
                IsTopicActiveResponse,
            ),
            "/emissions.v9.QueryService/GetTopicFeeRevenue": grpclib.const.Handler(
                self.__rpc_get_topic_fee_revenue,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicFeeRevenueRequest,
                GetTopicFeeRevenueResponse,
            ),
            "/emissions.v9.QueryService/GetInfererScoreEma": grpclib.const.Handler(
                self.__rpc_get_inferer_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetInfererScoreEmaRequest,
                GetInfererScoreEmaResponse,
            ),
            "/emissions.v9.QueryService/GetForecasterScoreEma": grpclib.const.Handler(
                self.__rpc_get_forecaster_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetForecasterScoreEmaRequest,
                GetForecasterScoreEmaResponse,
            ),
            "/emissions.v9.QueryService/GetReputerScoreEma": grpclib.const.Handler(
                self.__rpc_get_reputer_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetReputerScoreEmaRequest,
                GetReputerScoreEmaResponse,
            ),
            "/emissions.v9.QueryService/GetInferenceScoresUntilBlock": grpclib.const.Handler(
                self.__rpc_get_inference_scores_until_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetInferenceScoresUntilBlockRequest,
                GetInferenceScoresUntilBlockResponse,
            ),
            "/emissions.v9.QueryService/GetPreviousTopicQuantileForecasterScoreEma": grpclib.const.Handler(
                self.__rpc_get_previous_topic_quantile_forecaster_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousTopicQuantileForecasterScoreEmaRequest,
                GetPreviousTopicQuantileForecasterScoreEmaResponse,
            ),
            "/emissions.v9.QueryService/GetPreviousTopicQuantileInfererScoreEma": grpclib.const.Handler(
                self.__rpc_get_previous_topic_quantile_inferer_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousTopicQuantileInfererScoreEmaRequest,
                GetPreviousTopicQuantileInfererScoreEmaResponse,
            ),
            "/emissions.v9.QueryService/GetPreviousTopicQuantileReputerScoreEma": grpclib.const.Handler(
                self.__rpc_get_previous_topic_quantile_reputer_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousTopicQuantileReputerScoreEmaRequest,
                GetPreviousTopicQuantileReputerScoreEmaResponse,
            ),
            "/emissions.v9.QueryService/GetWorkerInferenceScoresAtBlock": grpclib.const.Handler(
                self.__rpc_get_worker_inference_scores_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetWorkerInferenceScoresAtBlockRequest,
                GetWorkerInferenceScoresAtBlockResponse,
            ),
            "/emissions.v9.QueryService/GetCurrentLowestInfererScore": grpclib.const.Handler(
                self.__rpc_get_current_lowest_inferer_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetCurrentLowestInfererScoreRequest,
                GetCurrentLowestInfererScoreResponse,
            ),
            "/emissions.v9.QueryService/GetForecastScoresUntilBlock": grpclib.const.Handler(
                self.__rpc_get_forecast_scores_until_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetForecastScoresUntilBlockRequest,
                GetForecastScoresUntilBlockResponse,
            ),
            "/emissions.v9.QueryService/GetWorkerForecastScoresAtBlock": grpclib.const.Handler(
                self.__rpc_get_worker_forecast_scores_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetWorkerForecastScoresAtBlockRequest,
                GetWorkerForecastScoresAtBlockResponse,
            ),
            "/emissions.v9.QueryService/GetCurrentLowestForecasterScore": grpclib.const.Handler(
                self.__rpc_get_current_lowest_forecaster_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetCurrentLowestForecasterScoreRequest,
                GetCurrentLowestForecasterScoreResponse,
            ),
            "/emissions.v9.QueryService/GetReputersScoresAtBlock": grpclib.const.Handler(
                self.__rpc_get_reputers_scores_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetReputersScoresAtBlockRequest,
                GetReputersScoresAtBlockResponse,
            ),
            "/emissions.v9.QueryService/GetCurrentLowestReputerScore": grpclib.const.Handler(
                self.__rpc_get_current_lowest_reputer_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetCurrentLowestReputerScoreRequest,
                GetCurrentLowestReputerScoreResponse,
            ),
            "/emissions.v9.QueryService/GetListeningCoefficient": grpclib.const.Handler(
                self.__rpc_get_listening_coefficient,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetListeningCoefficientRequest,
                GetListeningCoefficientResponse,
            ),
            "/emissions.v9.QueryService/GetPreviousReputerRewardFraction": grpclib.const.Handler(
                self.__rpc_get_previous_reputer_reward_fraction,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousReputerRewardFractionRequest,
                GetPreviousReputerRewardFractionResponse,
            ),
            "/emissions.v9.QueryService/GetPreviousInferenceRewardFraction": grpclib.const.Handler(
                self.__rpc_get_previous_inference_reward_fraction,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousInferenceRewardFractionRequest,
                GetPreviousInferenceRewardFractionResponse,
            ),
            "/emissions.v9.QueryService/GetPreviousForecastRewardFraction": grpclib.const.Handler(
                self.__rpc_get_previous_forecast_reward_fraction,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousForecastRewardFractionRequest,
                GetPreviousForecastRewardFractionResponse,
            ),
            "/emissions.v9.QueryService/GetPreviousPercentageRewardToStakedReputers": grpclib.const.Handler(
                self.__rpc_get_previous_percentage_reward_to_staked_reputers,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousPercentageRewardToStakedReputersRequest,
                GetPreviousPercentageRewardToStakedReputersResponse,
            ),
            "/emissions.v9.QueryService/GetTotalRewardToDistribute": grpclib.const.Handler(
                self.__rpc_get_total_reward_to_distribute,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTotalRewardToDistributeRequest,
                GetTotalRewardToDistributeResponse,
            ),
            "/emissions.v9.QueryService/GetNaiveInfererNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_naive_inferer_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNaiveInfererNetworkRegretRequest,
                GetNaiveInfererNetworkRegretResponse,
            ),
            "/emissions.v9.QueryService/GetOneOutInfererInfererNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_one_out_inferer_inferer_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetOneOutInfererInfererNetworkRegretRequest,
                GetOneOutInfererInfererNetworkRegretResponse,
            ),
            "/emissions.v9.QueryService/GetOneOutInfererForecasterNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_one_out_inferer_forecaster_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetOneOutInfererForecasterNetworkRegretRequest,
                GetOneOutInfererForecasterNetworkRegretResponse,
            ),
            "/emissions.v9.QueryService/GetOneOutForecasterInfererNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_one_out_forecaster_inferer_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetOneOutForecasterInfererNetworkRegretRequest,
                GetOneOutForecasterInfererNetworkRegretResponse,
            ),
            "/emissions.v9.QueryService/GetOneOutForecasterForecasterNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_one_out_forecaster_forecaster_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetOneOutForecasterForecasterNetworkRegretRequest,
                GetOneOutForecasterForecasterNetworkRegretResponse,
            ),
            "/emissions.v9.QueryService/GetActiveTopicsAtBlock": grpclib.const.Handler(
                self.__rpc_get_active_topics_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetActiveTopicsAtBlockRequest,
                GetActiveTopicsAtBlockResponse,
            ),
            "/emissions.v9.QueryService/GetNextChurningBlockByTopicId": grpclib.const.Handler(
                self.__rpc_get_next_churning_block_by_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNextChurningBlockByTopicIdRequest,
                GetNextChurningBlockByTopicIdResponse,
            ),
            "/emissions.v9.QueryService/GetCountInfererInclusionsInTopic": grpclib.const.Handler(
                self.__rpc_get_count_inferer_inclusions_in_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetCountInfererInclusionsInTopicRequest,
                GetCountInfererInclusionsInTopicResponse,
            ),
            "/emissions.v9.QueryService/GetCountForecasterInclusionsInTopic": grpclib.const.Handler(
                self.__rpc_get_count_forecaster_inclusions_in_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetCountForecasterInclusionsInTopicRequest,
                GetCountForecasterInclusionsInTopicResponse,
            ),
            "/emissions.v9.QueryService/GetActiveReputersForTopic": grpclib.const.Handler(
                self.__rpc_get_active_reputers_for_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetActiveReputersForTopicRequest,
                GetActiveReputersForTopicResponse,
            ),
            "/emissions.v9.QueryService/GetActiveForecastersForTopic": grpclib.const.Handler(
                self.__rpc_get_active_forecasters_for_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetActiveForecastersForTopicRequest,
                GetActiveForecastersForTopicResponse,
            ),
            "/emissions.v9.QueryService/GetActiveInferersForTopic": grpclib.const.Handler(
                self.__rpc_get_active_inferers_for_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetActiveInferersForTopicRequest,
                GetActiveInferersForTopicResponse,
            ),
            "/emissions.v9.QueryService/IsWhitelistedGlobalWorker": grpclib.const.Handler(
                self.__rpc_is_whitelisted_global_worker,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedGlobalWorkerRequest,
                IsWhitelistedGlobalWorkerResponse,
            ),
            "/emissions.v9.QueryService/IsWhitelistedGlobalReputer": grpclib.const.Handler(
                self.__rpc_is_whitelisted_global_reputer,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedGlobalReputerRequest,
                IsWhitelistedGlobalReputerResponse,
            ),
            "/emissions.v9.QueryService/IsWhitelistedGlobalAdmin": grpclib.const.Handler(
                self.__rpc_is_whitelisted_global_admin,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedGlobalAdminRequest,
                IsWhitelistedGlobalAdminResponse,
            ),
            "/emissions.v9.QueryService/IsTopicWorkerWhitelistEnabled": grpclib.const.Handler(
                self.__rpc_is_topic_worker_whitelist_enabled,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsTopicWorkerWhitelistEnabledRequest,
                IsTopicWorkerWhitelistEnabledResponse,
            ),
            "/emissions.v9.QueryService/IsTopicReputerWhitelistEnabled": grpclib.const.Handler(
                self.__rpc_is_topic_reputer_whitelist_enabled,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsTopicReputerWhitelistEnabledRequest,
                IsTopicReputerWhitelistEnabledResponse,
            ),
            "/emissions.v9.QueryService/IsWhitelistedTopicCreator": grpclib.const.Handler(
                self.__rpc_is_whitelisted_topic_creator,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedTopicCreatorRequest,
                IsWhitelistedTopicCreatorResponse,
            ),
            "/emissions.v9.QueryService/IsWhitelistedGlobalActor": grpclib.const.Handler(
                self.__rpc_is_whitelisted_global_actor,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedGlobalActorRequest,
                IsWhitelistedGlobalActorResponse,
            ),
            "/emissions.v9.QueryService/IsWhitelistedTopicWorker": grpclib.const.Handler(
                self.__rpc_is_whitelisted_topic_worker,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedTopicWorkerRequest,
                IsWhitelistedTopicWorkerResponse,
            ),
            "/emissions.v9.QueryService/IsWhitelistedTopicReputer": grpclib.const.Handler(
                self.__rpc_is_whitelisted_topic_reputer,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedTopicReputerRequest,
                IsWhitelistedTopicReputerResponse,
            ),
            "/emissions.v9.QueryService/CanUpdateAllGlobalWhitelists": grpclib.const.Handler(
                self.__rpc_can_update_all_global_whitelists,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanUpdateAllGlobalWhitelistsRequest,
                CanUpdateAllGlobalWhitelistsResponse,
            ),
            "/emissions.v9.QueryService/CanUpdateGlobalWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_can_update_global_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanUpdateGlobalWorkerWhitelistRequest,
                CanUpdateGlobalWorkerWhitelistResponse,
            ),
            "/emissions.v9.QueryService/CanUpdateGlobalReputerWhitelist": grpclib.const.Handler(
                self.__rpc_can_update_global_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanUpdateGlobalReputerWhitelistRequest,
                CanUpdateGlobalReputerWhitelistResponse,
            ),
            "/emissions.v9.QueryService/CanUpdateParams": grpclib.const.Handler(
                self.__rpc_can_update_params,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanUpdateParamsRequest,
                CanUpdateParamsResponse,
            ),
            "/emissions.v9.QueryService/CanUpdateTopicWhitelist": grpclib.const.Handler(
                self.__rpc_can_update_topic_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanUpdateTopicWhitelistRequest,
                CanUpdateTopicWhitelistResponse,
            ),
            "/emissions.v9.QueryService/CanCreateTopic": grpclib.const.Handler(
                self.__rpc_can_create_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanCreateTopicRequest,
                CanCreateTopicResponse,
            ),
            "/emissions.v9.QueryService/CanSubmitWorkerPayload": grpclib.const.Handler(
                self.__rpc_can_submit_worker_payload,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanSubmitWorkerPayloadRequest,
                CanSubmitWorkerPayloadResponse,
            ),
            "/emissions.v9.QueryService/CanSubmitReputerPayload": grpclib.const.Handler(
                self.__rpc_can_submit_reputer_payload,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanSubmitReputerPayloadRequest,
                CanSubmitReputerPayloadResponse,
            ),
            "/emissions.v9.QueryService/GetTopicInitialInfererEmaScore": grpclib.const.Handler(
                self.__rpc_get_topic_initial_inferer_ema_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicInitialInfererEmaScoreRequest,
                GetTopicInitialInfererEmaScoreResponse,
            ),
            "/emissions.v9.QueryService/GetTopicInitialForecasterEmaScore": grpclib.const.Handler(
                self.__rpc_get_topic_initial_forecaster_ema_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicInitialForecasterEmaScoreRequest,
                GetTopicInitialForecasterEmaScoreResponse,
            ),
            "/emissions.v9.QueryService/GetTopicInitialReputerEmaScore": grpclib.const.Handler(
                self.__rpc_get_topic_initial_reputer_ema_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicInitialReputerEmaScoreRequest,
                GetTopicInitialReputerEmaScoreResponse,
            ),
            "/emissions.v9.QueryService/GetLatestRegretStdNorm": grpclib.const.Handler(
                self.__rpc_get_latest_regret_std_norm,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestRegretStdNormRequest,
                GetLatestRegretStdNormResponse,
            ),
            "/emissions.v9.QueryService/GetLatestInfererWeight": grpclib.const.Handler(
                self.__rpc_get_latest_inferer_weight,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestInfererWeightRequest,
                GetLatestInfererWeightResponse,
            ),
            "/emissions.v9.QueryService/GetLatestForecasterWeight": grpclib.const.Handler(
                self.__rpc_get_latest_forecaster_weight,
                grpclib.const.Cardinality.UNARY_UNARY,
