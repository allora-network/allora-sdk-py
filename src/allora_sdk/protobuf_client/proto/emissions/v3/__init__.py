...
class Topic(betterproto.Message):
    ...
    merit_sortition_alpha: str = betterproto.string_field(18)
    """
    alpha parameter to weight previous score EMA importance in
     filtering the active set of inferers, forecasters, and reputers
    """

    active_inferer_quantile: str = betterproto.string_field(19)
    active_forecaster_quantile: str = betterproto.string_field(20)
    active_reputer_quantile: str = betterproto.string_field(21)
...
@dataclass(eq=False, repr=False)
class TopicIdWeightPair(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    weight: str = betterproto.string_field(2)
...
@dataclass(eq=False, repr=False)
class QueryLatestAvailableNetworkInferencesRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
...
@dataclass(eq=False, repr=False)
class QueryLatestAvailableNetworkInferencesResponse(betterproto.Message):
    network_inferences: "ValueBundle" = betterproto.message_field(1)
    inferer_weights: List["RegretInformedWeight"] = betterproto.message_field(2)
    forecaster_weights: List["RegretInformedWeight"] = betterproto.message_field(3)
    forecast_implied_inferences: List["WorkerAttributedValue"] = (
...
@dataclass(eq=False, repr=False)
class QueryTopicLastWorkerCommitInfoRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class QueryTopicLastWorkerCommitInfoResponse(betterproto.Message):
    last_commit: "TimestampedActorNonce" = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class QueryTopicLastReputerCommitInfoRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class QueryTopicLastReputerCommitInfoResponse(betterproto.Message):
    last_commit: "TimestampedActorNonce" = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class QueryGetInfererScoreEmaRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    inferer: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class QueryGetInfererScoreEmaResponse(betterproto.Message):
    score: "Score" = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class QueryGetForecasterScoreEmaRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    forecaster: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class QueryGetForecasterScoreEmaResponse(betterproto.Message):
    score: "Score" = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class QueryGetReputerScoreEmaRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
    reputer: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class QueryGetReputerScoreEmaResponse(betterproto.Message):
    score: "Score" = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class QueryGetPreviousTopicQuantileForecasterScoreEmaRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class QueryGetPreviousTopicQuantileForecasterScoreEmaResponse(betterproto.Message):
    value: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class QueryGetPreviousTopicQuantileInfererScoreEmaRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class QueryGetPreviousTopicQuantileInfererScoreEmaResponse(betterproto.Message):
    value: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class QueryGetPreviousTopicQuantileReputerScoreEmaRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class QueryGetPreviousTopicQuantileReputerScoreEmaResponse(betterproto.Message):
    value: str = betterproto.string_field(1)
...
@dataclass(eq=False, repr=False)
class QueryCurrentLowestInfererScoreRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class QueryCurrentLowestInfererScoreResponse(betterproto.Message):
    score: "Score" = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class QueryCurrentLowestForecasterScoreRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class QueryCurrentLowestForecasterScoreResponse(betterproto.Message):
    score: "Score" = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class QueryCurrentLowestReputerScoreRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class QueryCurrentLowestReputerScoreResponse(betterproto.Message):
    score: "Score" = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class QueryActiveTopicsAtBlockRequest(betterproto.Message):
    block_height: int = betterproto.int64_field(1)


@dataclass(eq=False, repr=False)
class QueryActiveTopicsAtBlockResponse(betterproto.Message):
    topics: List["Topic"] = betterproto.message_field(1)
    pagination: "SimpleCursorPaginationResponse" = betterproto.message_field(2)


@dataclass(eq=False, repr=False)
class QueryNextChurningBlockByTopicIdRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class QueryNextChurningBlockByTopicIdResponse(betterproto.Message):
    block_height: int = betterproto.int64_field(1)
...
class BlockHeightTopicIds(betterproto.Message):
    block_height: int = betterproto.int64_field(1)
    topic_ids: "TopicIds" = betterproto.message_field(2)


@dataclass(eq=False, repr=False)
class BlockHeightTopicIdWeightPair(betterproto.Message):
    block_height: int = betterproto.int64_field(1)
    topic_weight: "TopicIdWeightPair" = betterproto.message_field(2)
...
class QueryStub(betterproto.ServiceStub):
    ...
    async def get_latest_available_network_inference(
        self,
        query_latest_available_network_inferences_request: "QueryLatestAvailableNetworkInferencesRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_latest_available_network_inferences_request,
            QueryLatestAvailableNetworkInferencesResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_topic_last_worker_commit_info(
        self,
        query_topic_last_worker_commit_info_request: "QueryTopicLastWorkerCommitInfoRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_topic_last_worker_commit_info_request,
            QueryTopicLastWorkerCommitInfoResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_topic_last_reputer_commit_info(
        self,
        query_topic_last_reputer_commit_info_request: "QueryTopicLastReputerCommitInfoRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_topic_last_reputer_commit_info_request,
            QueryTopicLastReputerCommitInfoResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_inferer_score_ema(
        self,
        query_get_inferer_score_ema_request: "QueryGetInfererScoreEmaRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_get_inferer_score_ema_request,
            QueryGetInfererScoreEmaResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_forecaster_score_ema(
        self,
        query_get_forecaster_score_ema_request: "QueryGetForecasterScoreEmaRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_get_forecaster_score_ema_request,
            QueryGetForecasterScoreEmaResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_reputer_score_ema(
        self,
        query_get_reputer_score_ema_request: "QueryGetReputerScoreEmaRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_get_reputer_score_ema_request,
            QueryGetReputerScoreEmaResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_previous_topic_quantile_forecaster_score_ema(
        self,
        query_get_previous_topic_quantile_forecaster_score_ema_request: "QueryGetPreviousTopicQuantileForecasterScoreEmaRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_get_previous_topic_quantile_forecaster_score_ema_request,
            QueryGetPreviousTopicQuantileForecasterScoreEmaResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_previous_topic_quantile_inferer_score_ema(
        self,
        query_get_previous_topic_quantile_inferer_score_ema_request: "QueryGetPreviousTopicQuantileInfererScoreEmaRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_get_previous_topic_quantile_inferer_score_ema_request,
            QueryGetPreviousTopicQuantileInfererScoreEmaResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_previous_topic_quantile_reputer_score_ema(
        self,
        query_get_previous_topic_quantile_reputer_score_ema_request: "QueryGetPreviousTopicQuantileReputerScoreEmaRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_get_previous_topic_quantile_reputer_score_ema_request,
            QueryGetPreviousTopicQuantileReputerScoreEmaResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_current_lowest_inferer_score(
        self,
        query_current_lowest_inferer_score_request: "QueryCurrentLowestInfererScoreRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_current_lowest_inferer_score_request,
            QueryCurrentLowestInfererScoreResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_current_lowest_forecaster_score(
        self,
        query_current_lowest_forecaster_score_request: "QueryCurrentLowestForecasterScoreRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_current_lowest_forecaster_score_request,
            QueryCurrentLowestForecasterScoreResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_current_lowest_reputer_score(
        self,
        query_current_lowest_reputer_score_request: "QueryCurrentLowestReputerScoreRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_current_lowest_reputer_score_request,
            QueryCurrentLowestReputerScoreResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_active_topics_at_block(
        self,
        query_active_topics_at_block_request: "QueryActiveTopicsAtBlockRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_active_topics_at_block_request,
            QueryActiveTopicsAtBlockResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_next_churning_block_by_topic_id(
        self,
        query_next_churning_block_by_topic_id_request: "QueryNextChurningBlockByTopicIdRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            query_next_churning_block_by_topic_id_request,
            QueryNextChurningBlockByTopicIdResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class MsgBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/emissions.v3.Msg/UpdateParams": grpclib.const.Handler(
                self.__rpc_update_params,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgUpdateParams,
                MsgUpdateParamsResponse,
            ),
            "/emissions.v3.Msg/CreateNewTopic": grpclib.const.Handler(
                self.__rpc_create_new_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgCreateNewTopic,
                MsgCreateNewTopicResponse,
            ),
            "/emissions.v3.Msg/Register": grpclib.const.Handler(
                self.__rpc_register,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgRegister,
                MsgRegisterResponse,
            ),
            "/emissions.v3.Msg/RemoveRegistration": grpclib.const.Handler(
                self.__rpc_remove_registration,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgRemoveRegistration,
                MsgRemoveRegistrationResponse,
            ),
            "/emissions.v3.Msg/AddStake": grpclib.const.Handler(
                self.__rpc_add_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgAddStake,
                MsgAddStakeResponse,
            ),
            "/emissions.v3.Msg/RemoveStake": grpclib.const.Handler(
                self.__rpc_remove_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgRemoveStake,
                MsgRemoveStakeResponse,
            ),
            "/emissions.v3.Msg/CancelRemoveStake": grpclib.const.Handler(
                self.__rpc_cancel_remove_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgCancelRemoveStake,
                MsgCancelRemoveStakeResponse,
            ),
            "/emissions.v3.Msg/DelegateStake": grpclib.const.Handler(
                self.__rpc_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgDelegateStake,
                MsgDelegateStakeResponse,
            ),
            "/emissions.v3.Msg/RewardDelegateStake": grpclib.const.Handler(
                self.__rpc_reward_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgRewardDelegateStake,
                MsgRewardDelegateStakeResponse,
            ),
            "/emissions.v3.Msg/RemoveDelegateStake": grpclib.const.Handler(
                self.__rpc_remove_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgRemoveDelegateStake,
                MsgRemoveDelegateStakeResponse,
            ),
            "/emissions.v3.Msg/CancelRemoveDelegateStake": grpclib.const.Handler(
                self.__rpc_cancel_remove_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgCancelRemoveDelegateStake,
                MsgCancelRemoveDelegateStakeResponse,
            ),
            "/emissions.v3.Msg/FundTopic": grpclib.const.Handler(
                self.__rpc_fund_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgFundTopic,
                MsgFundTopicResponse,
            ),
            "/emissions.v3.Msg/AddToWhitelistAdmin": grpclib.const.Handler(
                self.__rpc_add_to_whitelist_admin,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgAddToWhitelistAdmin,
                MsgAddToWhitelistAdminResponse,
            ),
            "/emissions.v3.Msg/RemoveFromWhitelistAdmin": grpclib.const.Handler(
                self.__rpc_remove_from_whitelist_admin,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgRemoveFromWhitelistAdmin,
                MsgRemoveFromWhitelistAdminResponse,
            ),
            "/emissions.v3.Msg/InsertWorkerPayload": grpclib.const.Handler(
                self.__rpc_insert_worker_payload,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgInsertWorkerPayload,
                MsgInsertWorkerPayloadResponse,
            ),
            "/emissions.v3.Msg/InsertReputerPayload": grpclib.const.Handler(
...
class QueryBase(ServiceBase):
    ...
    async def get_inferer_score_ema(
        self, query_get_inferer_score_ema_request: "QueryGetInfererScoreEmaRequest"
    ) -> "QueryGetInfererScoreEmaResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_reputer_score_ema(
        self, query_get_reputer_score_ema_request: "QueryGetReputerScoreEmaRequest"
    ) -> "QueryGetReputerScoreEmaResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_active_topics_at_block(
        self, query_active_topics_at_block_request: "QueryActiveTopicsAtBlockRequest"
    ) -> "QueryActiveTopicsAtBlockResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_get_latest_available_network_inference(
        self,
        stream: "grpclib.server.Stream[QueryLatestAvailableNetworkInferencesRequest, QueryLatestAvailableNetworkInferencesResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_topic_last_worker_commit_info(
        self,
        stream: "grpclib.server.Stream[QueryTopicLastWorkerCommitInfoRequest, QueryTopicLastWorkerCommitInfoResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_topic_last_reputer_commit_info(
        self,
        stream: "grpclib.server.Stream[QueryTopicLastReputerCommitInfoRequest, QueryTopicLastReputerCommitInfoResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_inferer_score_ema(
        self,
        stream: "grpclib.server.Stream[QueryGetInfererScoreEmaRequest, QueryGetInfererScoreEmaResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_forecaster_score_ema(
        self,
        stream: "grpclib.server.Stream[QueryGetForecasterScoreEmaRequest, QueryGetForecasterScoreEmaResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_reputer_score_ema(
        self,
        stream: "grpclib.server.Stream[QueryGetReputerScoreEmaRequest, QueryGetReputerScoreEmaResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_previous_topic_quantile_forecaster_score_ema(
        self,
        stream: "grpclib.server.Stream[QueryGetPreviousTopicQuantileForecasterScoreEmaRequest, QueryGetPreviousTopicQuantileForecasterScoreEmaResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_previous_topic_quantile_inferer_score_ema(
        self,
        stream: "grpclib.server.Stream[QueryGetPreviousTopicQuantileInfererScoreEmaRequest, QueryGetPreviousTopicQuantileInfererScoreEmaResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_previous_topic_quantile_reputer_score_ema(
        self,
        stream: "grpclib.server.Stream[QueryGetPreviousTopicQuantileReputerScoreEmaRequest, QueryGetPreviousTopicQuantileReputerScoreEmaResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_current_lowest_inferer_score(
        self,
        stream: "grpclib.server.Stream[QueryCurrentLowestInfererScoreRequest, QueryCurrentLowestInfererScoreResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_current_lowest_forecaster_score(
        self,
        stream: "grpclib.server.Stream[QueryCurrentLowestForecasterScoreRequest, QueryCurrentLowestForecasterScoreResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_current_lowest_reputer_score(
        self,
        stream: "grpclib.server.Stream[QueryCurrentLowestReputerScoreRequest, QueryCurrentLowestReputerScoreResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_active_topics_at_block(
        self,
        stream: "grpclib.server.Stream[QueryActiveTopicsAtBlockRequest, QueryActiveTopicsAtBlockResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_next_churning_block_by_topic_id(
        self,
        stream: "grpclib.server.Stream[QueryNextChurningBlockByTopicIdRequest, QueryNextChurningBlockByTopicIdResponse]",
    ) -> None:
        request = await stream.recv_message()
