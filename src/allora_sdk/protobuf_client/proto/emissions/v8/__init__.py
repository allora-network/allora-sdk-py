...
class Params(betterproto.Message):
    ...
    inference_outlier_detection_threshold: str = betterproto.string_field(53)
    """for calculating the topic initial regret"""

    inference_outlier_detection_alpha: str = betterproto.string_field(54)
    lambda_initial_score: str = betterproto.string_field(55)
    global_worker_whitelist_enabled: bool = betterproto.bool_field(56)
    global_reputer_whitelist_enabled: bool = betterproto.bool_field(57)
    global_admin_whitelist_appended: bool = betterproto.bool_field(58)
    max_whitelist_input_array_length: int = betterproto.uint64_field(59)
    min_weight_threshold_for_stdnorm: str = betterproto.string_field(60)
...
@dataclass(eq=False, repr=False)
class GetLatestAvailableNetworkInferencesOutlierResistantRequest(betterproto.Message):
    topic_id: int = betterproto.uint64_field(1)
...
@dataclass(eq=False, repr=False)
class GetLatestAvailableNetworkInferencesOutlierResistantResponse(betterproto.Message):
    network_inferences: "_v3__.ValueBundle" = betterproto.message_field(1)
    inferer_weights: List["_v3__.RegretInformedWeight"] = betterproto.message_field(2)
    forecaster_weights: List["_v3__.RegretInformedWeight"] = betterproto.message_field(
        3
...
class QueryServiceStub(betterproto.ServiceStub):
    ...
    async def get_latest_available_network_inferences_outlier_resistant(
        self,
        get_latest_available_network_inferences_outlier_resistant_request: "GetLatestAvailableNetworkInferencesOutlierResistantRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            get_latest_available_network_inferences_outlier_resistant_request,
            GetLatestAvailableNetworkInferencesOutlierResistantResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class MsgServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/emissions.v8.MsgService/UpdateParams": grpclib.const.Handler(
                self.__rpc_update_params,
                grpclib.const.Cardinality.UNARY_UNARY,
                UpdateParamsRequest,
                UpdateParamsResponse,
            ),
            "/emissions.v8.MsgService/CreateNewTopic": grpclib.const.Handler(
                self.__rpc_create_new_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                CreateNewTopicRequest,
                CreateNewTopicResponse,
            ),
            "/emissions.v8.MsgService/Register": grpclib.const.Handler(
                self.__rpc_register,
                grpclib.const.Cardinality.UNARY_UNARY,
                RegisterRequest,
                RegisterResponse,
            ),
            "/emissions.v8.MsgService/RemoveRegistration": grpclib.const.Handler(
                self.__rpc_remove_registration,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveRegistrationRequest,
                RemoveRegistrationResponse,
            ),
            "/emissions.v8.MsgService/AddStake": grpclib.const.Handler(
                self.__rpc_add_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddStakeRequest,
                AddStakeResponse,
            ),
            "/emissions.v8.MsgService/RemoveStake": grpclib.const.Handler(
                self.__rpc_remove_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveStakeRequest,
                RemoveStakeResponse,
            ),
            "/emissions.v8.MsgService/CancelRemoveStake": grpclib.const.Handler(
                self.__rpc_cancel_remove_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                CancelRemoveStakeRequest,
                CancelRemoveStakeResponse,
            ),
            "/emissions.v8.MsgService/DelegateStake": grpclib.const.Handler(
                self.__rpc_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                DelegateStakeRequest,
                DelegateStakeResponse,
            ),
            "/emissions.v8.MsgService/RewardDelegateStake": grpclib.const.Handler(
                self.__rpc_reward_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                RewardDelegateStakeRequest,
                RewardDelegateStakeResponse,
            ),
            "/emissions.v8.MsgService/RemoveDelegateStake": grpclib.const.Handler(
                self.__rpc_remove_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveDelegateStakeRequest,
                RemoveDelegateStakeResponse,
            ),
            "/emissions.v8.MsgService/CancelRemoveDelegateStake": grpclib.const.Handler(
                self.__rpc_cancel_remove_delegate_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                CancelRemoveDelegateStakeRequest,
                CancelRemoveDelegateStakeResponse,
            ),
            "/emissions.v8.MsgService/FundTopic": grpclib.const.Handler(
                self.__rpc_fund_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                FundTopicRequest,
                FundTopicResponse,
            ),
            "/emissions.v8.MsgService/AddToWhitelistAdmin": grpclib.const.Handler(
                self.__rpc_add_to_whitelist_admin,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToWhitelistAdminRequest,
                AddToWhitelistAdminResponse,
            ),
            "/emissions.v8.MsgService/RemoveFromWhitelistAdmin": grpclib.const.Handler(
                self.__rpc_remove_from_whitelist_admin,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromWhitelistAdminRequest,
                RemoveFromWhitelistAdminResponse,
            ),
            "/emissions.v8.MsgService/InsertWorkerPayload": grpclib.const.Handler(
                self.__rpc_insert_worker_payload,
                grpclib.const.Cardinality.UNARY_UNARY,
                InsertWorkerPayloadRequest,
                InsertWorkerPayloadResponse,
            ),
            "/emissions.v8.MsgService/InsertReputerPayload": grpclib.const.Handler(
                self.__rpc_insert_reputer_payload,
                grpclib.const.Cardinality.UNARY_UNARY,
                InsertReputerPayloadRequest,
                InsertReputerPayloadResponse,
            ),
            "/emissions.v8.MsgService/AddToGlobalWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_global_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToGlobalWhitelistRequest,
                AddToGlobalWhitelistResponse,
            ),
            "/emissions.v8.MsgService/RemoveFromGlobalWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_global_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromGlobalWhitelistRequest,
                RemoveFromGlobalWhitelistResponse,
            ),
            "/emissions.v8.MsgService/AddToGlobalWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_global_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToGlobalWorkerWhitelistRequest,
                AddToGlobalWorkerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/RemoveFromGlobalWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_global_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromGlobalWorkerWhitelistRequest,
                RemoveFromGlobalWorkerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/AddToGlobalReputerWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_global_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToGlobalReputerWhitelistRequest,
                AddToGlobalReputerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/RemoveFromGlobalReputerWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_global_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromGlobalReputerWhitelistRequest,
                RemoveFromGlobalReputerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/AddToGlobalAdminWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_global_admin_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToGlobalAdminWhitelistRequest,
                AddToGlobalAdminWhitelistResponse,
            ),
            "/emissions.v8.MsgService/RemoveFromGlobalAdminWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_global_admin_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromGlobalAdminWhitelistRequest,
                RemoveFromGlobalAdminWhitelistResponse,
            ),
            "/emissions.v8.MsgService/BulkAddToGlobalWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_add_to_global_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkAddToGlobalWorkerWhitelistRequest,
                BulkAddToGlobalWorkerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/BulkRemoveFromGlobalWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_remove_from_global_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkRemoveFromGlobalWorkerWhitelistRequest,
                BulkRemoveFromGlobalWorkerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/BulkAddToGlobalReputerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_add_to_global_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkAddToGlobalReputerWhitelistRequest,
                BulkAddToGlobalReputerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/BulkRemoveFromGlobalReputerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_remove_from_global_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkRemoveFromGlobalReputerWhitelistRequest,
                BulkRemoveFromGlobalReputerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/BulkAddToTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_add_to_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkAddToTopicWorkerWhitelistRequest,
                BulkAddToTopicWorkerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/BulkRemoveFromTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_remove_from_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkRemoveFromTopicWorkerWhitelistRequest,
                BulkRemoveFromTopicWorkerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/BulkAddToTopicReputerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_add_to_topic_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkAddToTopicReputerWhitelistRequest,
                BulkAddToTopicReputerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/BulkRemoveFromTopicReputerWhitelist": grpclib.const.Handler(
                self.__rpc_bulk_remove_from_topic_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                BulkRemoveFromTopicReputerWhitelistRequest,
                BulkRemoveFromTopicReputerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/EnableTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_enable_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                EnableTopicWorkerWhitelistRequest,
                EnableTopicWorkerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/DisableTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_disable_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                DisableTopicWorkerWhitelistRequest,
                DisableTopicWorkerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/EnableTopicReputerWhitelist": grpclib.const.Handler(
                self.__rpc_enable_topic_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                EnableTopicReputerWhitelistRequest,
                EnableTopicReputerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/DisableTopicReputerWhitelist": grpclib.const.Handler(
                self.__rpc_disable_topic_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                DisableTopicReputerWhitelistRequest,
                DisableTopicReputerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/AddToTopicCreatorWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_topic_creator_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToTopicCreatorWhitelistRequest,
                AddToTopicCreatorWhitelistResponse,
            ),
            "/emissions.v8.MsgService/RemoveFromTopicCreatorWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_topic_creator_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromTopicCreatorWhitelistRequest,
                RemoveFromTopicCreatorWhitelistResponse,
            ),
            "/emissions.v8.MsgService/AddToTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToTopicWorkerWhitelistRequest,
                AddToTopicWorkerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/RemoveFromTopicWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_remove_from_topic_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFromTopicWorkerWhitelistRequest,
                RemoveFromTopicWorkerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/AddToTopicReputerWhitelist": grpclib.const.Handler(
                self.__rpc_add_to_topic_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddToTopicReputerWhitelistRequest,
                AddToTopicReputerWhitelistResponse,
            ),
            "/emissions.v8.MsgService/RemoveFromTopicReputerWhitelist": grpclib.const.Handler(
...
class QueryServiceBase(ServiceBase):
    ...
    async def __rpc_get_latest_available_network_inferences_outlier_resistant(
        self,
        stream: "grpclib.server.Stream[GetLatestAvailableNetworkInferencesOutlierResistantRequest, GetLatestAvailableNetworkInferencesOutlierResistantResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_latest_available_network_inferences_outlier_resistant(
            request
        )
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/emissions.v8.QueryService/GetParams": grpclib.const.Handler(
                self.__rpc_get_params,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetParamsRequest,
                GetParamsResponse,
            ),
            "/emissions.v8.QueryService/GetNextTopicId": grpclib.const.Handler(
                self.__rpc_get_next_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNextTopicIdRequest,
                GetNextTopicIdResponse,
            ),
            "/emissions.v8.QueryService/GetTopic": grpclib.const.Handler(
                self.__rpc_get_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicRequest,
                GetTopicResponse,
            ),
            "/emissions.v8.QueryService/GetWorkerLatestInferenceByTopicId": grpclib.const.Handler(
                self.__rpc_get_worker_latest_inference_by_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetWorkerLatestInferenceByTopicIdRequest,
                GetWorkerLatestInferenceByTopicIdResponse,
            ),
            "/emissions.v8.QueryService/GetInferencesAtBlock": grpclib.const.Handler(
                self.__rpc_get_inferences_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetInferencesAtBlockRequest,
                GetInferencesAtBlockResponse,
            ),
            "/emissions.v8.QueryService/GetLatestTopicInferences": grpclib.const.Handler(
                self.__rpc_get_latest_topic_inferences,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestTopicInferencesRequest,
                GetLatestTopicInferencesResponse,
            ),
            "/emissions.v8.QueryService/GetForecastsAtBlock": grpclib.const.Handler(
                self.__rpc_get_forecasts_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetForecastsAtBlockRequest,
                GetForecastsAtBlockResponse,
            ),
            "/emissions.v8.QueryService/GetNetworkLossBundleAtBlock": grpclib.const.Handler(
                self.__rpc_get_network_loss_bundle_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNetworkLossBundleAtBlockRequest,
                GetNetworkLossBundleAtBlockResponse,
            ),
            "/emissions.v8.QueryService/GetTotalStake": grpclib.const.Handler(
                self.__rpc_get_total_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTotalStakeRequest,
                GetTotalStakeResponse,
            ),
            "/emissions.v8.QueryService/GetReputerStakeInTopic": grpclib.const.Handler(
                self.__rpc_get_reputer_stake_in_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetReputerStakeInTopicRequest,
                GetReputerStakeInTopicResponse,
            ),
            "/emissions.v8.QueryService/GetMultiReputerStakeInTopic": grpclib.const.Handler(
                self.__rpc_get_multi_reputer_stake_in_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetMultiReputerStakeInTopicRequest,
                GetMultiReputerStakeInTopicResponse,
            ),
            "/emissions.v8.QueryService/GetStakeFromReputerInTopicInSelf": grpclib.const.Handler(
                self.__rpc_get_stake_from_reputer_in_topic_in_self,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeFromReputerInTopicInSelfRequest,
                GetStakeFromReputerInTopicInSelfResponse,
            ),
            "/emissions.v8.QueryService/GetDelegateStakeInTopicInReputer": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_in_topic_in_reputer,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakeInTopicInReputerRequest,
                GetDelegateStakeInTopicInReputerResponse,
            ),
            "/emissions.v8.QueryService/GetStakeFromDelegatorInTopicInReputer": grpclib.const.Handler(
                self.__rpc_get_stake_from_delegator_in_topic_in_reputer,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeFromDelegatorInTopicInReputerRequest,
                GetStakeFromDelegatorInTopicInReputerResponse,
            ),
            "/emissions.v8.QueryService/GetStakeFromDelegatorInTopic": grpclib.const.Handler(
                self.__rpc_get_stake_from_delegator_in_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeFromDelegatorInTopicRequest,
                GetStakeFromDelegatorInTopicResponse,
            ),
            "/emissions.v8.QueryService/GetTopicStake": grpclib.const.Handler(
                self.__rpc_get_topic_stake,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicStakeRequest,
                GetTopicStakeResponse,
            ),
            "/emissions.v8.QueryService/GetStakeRemovalsUpUntilBlock": grpclib.const.Handler(
                self.__rpc_get_stake_removals_up_until_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeRemovalsUpUntilBlockRequest,
                GetStakeRemovalsUpUntilBlockResponse,
            ),
            "/emissions.v8.QueryService/GetDelegateStakeRemovalsUpUntilBlock": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_removals_up_until_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakeRemovalsUpUntilBlockRequest,
                GetDelegateStakeRemovalsUpUntilBlockResponse,
            ),
            "/emissions.v8.QueryService/GetStakeRemovalInfo": grpclib.const.Handler(
                self.__rpc_get_stake_removal_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeRemovalInfoRequest,
                GetStakeRemovalInfoResponse,
            ),
            "/emissions.v8.QueryService/GetDelegateStakeRemovalInfo": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_removal_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakeRemovalInfoRequest,
                GetDelegateStakeRemovalInfoResponse,
            ),
            "/emissions.v8.QueryService/GetWorkerNodeInfo": grpclib.const.Handler(
                self.__rpc_get_worker_node_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetWorkerNodeInfoRequest,
                GetWorkerNodeInfoResponse,
            ),
            "/emissions.v8.QueryService/GetReputerNodeInfo": grpclib.const.Handler(
                self.__rpc_get_reputer_node_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetReputerNodeInfoRequest,
                GetReputerNodeInfoResponse,
            ),
            "/emissions.v8.QueryService/IsWorkerRegisteredInTopicId": grpclib.const.Handler(
                self.__rpc_is_worker_registered_in_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWorkerRegisteredInTopicIdRequest,
                IsWorkerRegisteredInTopicIdResponse,
            ),
            "/emissions.v8.QueryService/IsReputerRegisteredInTopicId": grpclib.const.Handler(
                self.__rpc_is_reputer_registered_in_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsReputerRegisteredInTopicIdRequest,
                IsReputerRegisteredInTopicIdResponse,
            ),
            "/emissions.v8.QueryService/GetNetworkInferencesAtBlock": grpclib.const.Handler(
                self.__rpc_get_network_inferences_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNetworkInferencesAtBlockRequest,
                GetNetworkInferencesAtBlockResponse,
            ),
            "/emissions.v8.QueryService/GetNetworkInferencesAtBlockOutlierResistant": grpclib.const.Handler(
                self.__rpc_get_network_inferences_at_block_outlier_resistant,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNetworkInferencesAtBlockOutlierResistantRequest,
                GetNetworkInferencesAtBlockOutlierResistantResponse,
            ),
            "/emissions.v8.QueryService/GetLatestNetworkInferences": grpclib.const.Handler(
                self.__rpc_get_latest_network_inferences,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestNetworkInferencesRequest,
                GetLatestNetworkInferencesResponse,
            ),
            "/emissions.v8.QueryService/GetLatestNetworkInferencesOutlierResistant": grpclib.const.Handler(
                self.__rpc_get_latest_network_inferences_outlier_resistant,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestNetworkInferencesOutlierResistantRequest,
                GetLatestNetworkInferencesOutlierResistantResponse,
            ),
            "/emissions.v8.QueryService/GetLatestAvailableNetworkInferences": grpclib.const.Handler(
                self.__rpc_get_latest_available_network_inferences,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestAvailableNetworkInferencesRequest,
                GetLatestAvailableNetworkInferencesResponse,
            ),
            "/emissions.v8.QueryService/GetLatestAvailableNetworkInferencesOutlierResistant": grpclib.const.Handler(
                self.__rpc_get_latest_available_network_inferences_outlier_resistant,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestAvailableNetworkInferencesOutlierResistantRequest,
                GetLatestAvailableNetworkInferencesOutlierResistantResponse,
            ),
            "/emissions.v8.QueryService/IsWorkerNonceUnfulfilled": grpclib.const.Handler(
                self.__rpc_is_worker_nonce_unfulfilled,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWorkerNonceUnfulfilledRequest,
                IsWorkerNonceUnfulfilledResponse,
            ),
            "/emissions.v8.QueryService/IsReputerNonceUnfulfilled": grpclib.const.Handler(
                self.__rpc_is_reputer_nonce_unfulfilled,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsReputerNonceUnfulfilledRequest,
                IsReputerNonceUnfulfilledResponse,
            ),
            "/emissions.v8.QueryService/GetUnfulfilledWorkerNonces": grpclib.const.Handler(
                self.__rpc_get_unfulfilled_worker_nonces,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetUnfulfilledWorkerNoncesRequest,
                GetUnfulfilledWorkerNoncesResponse,
            ),
            "/emissions.v8.QueryService/GetUnfulfilledReputerNonces": grpclib.const.Handler(
                self.__rpc_get_unfulfilled_reputer_nonces,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetUnfulfilledReputerNoncesRequest,
                GetUnfulfilledReputerNoncesResponse,
            ),
            "/emissions.v8.QueryService/GetInfererNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_inferer_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetInfererNetworkRegretRequest,
                GetInfererNetworkRegretResponse,
            ),
            "/emissions.v8.QueryService/GetForecasterNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_forecaster_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetForecasterNetworkRegretRequest,
                GetForecasterNetworkRegretResponse,
            ),
            "/emissions.v8.QueryService/GetOneInForecasterNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_one_in_forecaster_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetOneInForecasterNetworkRegretRequest,
                GetOneInForecasterNetworkRegretResponse,
            ),
            "/emissions.v8.QueryService/IsWhitelistAdmin": grpclib.const.Handler(
                self.__rpc_is_whitelist_admin,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistAdminRequest,
                IsWhitelistAdminResponse,
            ),
            "/emissions.v8.QueryService/GetTopicLastWorkerCommitInfo": grpclib.const.Handler(
                self.__rpc_get_topic_last_worker_commit_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicLastWorkerCommitInfoRequest,
                GetTopicLastWorkerCommitInfoResponse,
            ),
            "/emissions.v8.QueryService/GetTopicLastReputerCommitInfo": grpclib.const.Handler(
                self.__rpc_get_topic_last_reputer_commit_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicLastReputerCommitInfoRequest,
                GetTopicLastReputerCommitInfoResponse,
            ),
            "/emissions.v8.QueryService/GetTopicRewardNonce": grpclib.const.Handler(
                self.__rpc_get_topic_reward_nonce,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicRewardNonceRequest,
                GetTopicRewardNonceResponse,
            ),
            "/emissions.v8.QueryService/GetReputerLossBundlesAtBlock": grpclib.const.Handler(
                self.__rpc_get_reputer_loss_bundles_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetReputerLossBundlesAtBlockRequest,
                GetReputerLossBundlesAtBlockResponse,
            ),
            "/emissions.v8.QueryService/GetStakeReputerAuthority": grpclib.const.Handler(
                self.__rpc_get_stake_reputer_authority,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeReputerAuthorityRequest,
                GetStakeReputerAuthorityResponse,
            ),
            "/emissions.v8.QueryService/GetDelegateStakePlacement": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_placement,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakePlacementRequest,
                GetDelegateStakePlacementResponse,
            ),
            "/emissions.v8.QueryService/GetDelegateStakeUponReputer": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_upon_reputer,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakeUponReputerRequest,
                GetDelegateStakeUponReputerResponse,
            ),
            "/emissions.v8.QueryService/GetDelegateRewardPerShare": grpclib.const.Handler(
                self.__rpc_get_delegate_reward_per_share,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateRewardPerShareRequest,
                GetDelegateRewardPerShareResponse,
            ),
            "/emissions.v8.QueryService/GetStakeRemovalForReputerAndTopicId": grpclib.const.Handler(
                self.__rpc_get_stake_removal_for_reputer_and_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetStakeRemovalForReputerAndTopicIdRequest,
                GetStakeRemovalForReputerAndTopicIdResponse,
            ),
            "/emissions.v8.QueryService/GetDelegateStakeRemoval": grpclib.const.Handler(
                self.__rpc_get_delegate_stake_removal,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDelegateStakeRemovalRequest,
                GetDelegateStakeRemovalResponse,
            ),
            "/emissions.v8.QueryService/GetPreviousTopicWeight": grpclib.const.Handler(
                self.__rpc_get_previous_topic_weight,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousTopicWeightRequest,
                GetPreviousTopicWeightResponse,
            ),
            "/emissions.v8.QueryService/GetTotalSumPreviousTopicWeights": grpclib.const.Handler(
                self.__rpc_get_total_sum_previous_topic_weights,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTotalSumPreviousTopicWeightsRequest,
                GetTotalSumPreviousTopicWeightsResponse,
            ),
            "/emissions.v8.QueryService/TopicExists": grpclib.const.Handler(
                self.__rpc_topic_exists,
                grpclib.const.Cardinality.UNARY_UNARY,
                TopicExistsRequest,
                TopicExistsResponse,
            ),
            "/emissions.v8.QueryService/IsTopicActive": grpclib.const.Handler(
                self.__rpc_is_topic_active,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsTopicActiveRequest,
                IsTopicActiveResponse,
            ),
            "/emissions.v8.QueryService/GetTopicFeeRevenue": grpclib.const.Handler(
                self.__rpc_get_topic_fee_revenue,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicFeeRevenueRequest,
                GetTopicFeeRevenueResponse,
            ),
            "/emissions.v8.QueryService/GetInfererScoreEma": grpclib.const.Handler(
                self.__rpc_get_inferer_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetInfererScoreEmaRequest,
                GetInfererScoreEmaResponse,
            ),
            "/emissions.v8.QueryService/GetForecasterScoreEma": grpclib.const.Handler(
                self.__rpc_get_forecaster_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetForecasterScoreEmaRequest,
                GetForecasterScoreEmaResponse,
            ),
            "/emissions.v8.QueryService/GetReputerScoreEma": grpclib.const.Handler(
                self.__rpc_get_reputer_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetReputerScoreEmaRequest,
                GetReputerScoreEmaResponse,
            ),
            "/emissions.v8.QueryService/GetInferenceScoresUntilBlock": grpclib.const.Handler(
                self.__rpc_get_inference_scores_until_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetInferenceScoresUntilBlockRequest,
                GetInferenceScoresUntilBlockResponse,
            ),
            "/emissions.v8.QueryService/GetPreviousTopicQuantileForecasterScoreEma": grpclib.const.Handler(
                self.__rpc_get_previous_topic_quantile_forecaster_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousTopicQuantileForecasterScoreEmaRequest,
                GetPreviousTopicQuantileForecasterScoreEmaResponse,
            ),
            "/emissions.v8.QueryService/GetPreviousTopicQuantileInfererScoreEma": grpclib.const.Handler(
                self.__rpc_get_previous_topic_quantile_inferer_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousTopicQuantileInfererScoreEmaRequest,
                GetPreviousTopicQuantileInfererScoreEmaResponse,
            ),
            "/emissions.v8.QueryService/GetPreviousTopicQuantileReputerScoreEma": grpclib.const.Handler(
                self.__rpc_get_previous_topic_quantile_reputer_score_ema,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousTopicQuantileReputerScoreEmaRequest,
                GetPreviousTopicQuantileReputerScoreEmaResponse,
            ),
            "/emissions.v8.QueryService/GetWorkerInferenceScoresAtBlock": grpclib.const.Handler(
                self.__rpc_get_worker_inference_scores_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetWorkerInferenceScoresAtBlockRequest,
                GetWorkerInferenceScoresAtBlockResponse,
            ),
            "/emissions.v8.QueryService/GetCurrentLowestInfererScore": grpclib.const.Handler(
                self.__rpc_get_current_lowest_inferer_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetCurrentLowestInfererScoreRequest,
                GetCurrentLowestInfererScoreResponse,
            ),
            "/emissions.v8.QueryService/GetForecastScoresUntilBlock": grpclib.const.Handler(
                self.__rpc_get_forecast_scores_until_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetForecastScoresUntilBlockRequest,
                GetForecastScoresUntilBlockResponse,
            ),
            "/emissions.v8.QueryService/GetWorkerForecastScoresAtBlock": grpclib.const.Handler(
                self.__rpc_get_worker_forecast_scores_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetWorkerForecastScoresAtBlockRequest,
                GetWorkerForecastScoresAtBlockResponse,
            ),
            "/emissions.v8.QueryService/GetCurrentLowestForecasterScore": grpclib.const.Handler(
                self.__rpc_get_current_lowest_forecaster_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetCurrentLowestForecasterScoreRequest,
                GetCurrentLowestForecasterScoreResponse,
            ),
            "/emissions.v8.QueryService/GetReputersScoresAtBlock": grpclib.const.Handler(
                self.__rpc_get_reputers_scores_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetReputersScoresAtBlockRequest,
                GetReputersScoresAtBlockResponse,
            ),
            "/emissions.v8.QueryService/GetCurrentLowestReputerScore": grpclib.const.Handler(
                self.__rpc_get_current_lowest_reputer_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetCurrentLowestReputerScoreRequest,
                GetCurrentLowestReputerScoreResponse,
            ),
            "/emissions.v8.QueryService/GetListeningCoefficient": grpclib.const.Handler(
                self.__rpc_get_listening_coefficient,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetListeningCoefficientRequest,
                GetListeningCoefficientResponse,
            ),
            "/emissions.v8.QueryService/GetPreviousReputerRewardFraction": grpclib.const.Handler(
                self.__rpc_get_previous_reputer_reward_fraction,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousReputerRewardFractionRequest,
                GetPreviousReputerRewardFractionResponse,
            ),
            "/emissions.v8.QueryService/GetPreviousInferenceRewardFraction": grpclib.const.Handler(
                self.__rpc_get_previous_inference_reward_fraction,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousInferenceRewardFractionRequest,
                GetPreviousInferenceRewardFractionResponse,
            ),
            "/emissions.v8.QueryService/GetPreviousForecastRewardFraction": grpclib.const.Handler(
                self.__rpc_get_previous_forecast_reward_fraction,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousForecastRewardFractionRequest,
                GetPreviousForecastRewardFractionResponse,
            ),
            "/emissions.v8.QueryService/GetPreviousPercentageRewardToStakedReputers": grpclib.const.Handler(
                self.__rpc_get_previous_percentage_reward_to_staked_reputers,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPreviousPercentageRewardToStakedReputersRequest,
                GetPreviousPercentageRewardToStakedReputersResponse,
            ),
            "/emissions.v8.QueryService/GetTotalRewardToDistribute": grpclib.const.Handler(
                self.__rpc_get_total_reward_to_distribute,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTotalRewardToDistributeRequest,
                GetTotalRewardToDistributeResponse,
            ),
            "/emissions.v8.QueryService/GetNaiveInfererNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_naive_inferer_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNaiveInfererNetworkRegretRequest,
                GetNaiveInfererNetworkRegretResponse,
            ),
            "/emissions.v8.QueryService/GetOneOutInfererInfererNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_one_out_inferer_inferer_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetOneOutInfererInfererNetworkRegretRequest,
                GetOneOutInfererInfererNetworkRegretResponse,
            ),
            "/emissions.v8.QueryService/GetOneOutInfererForecasterNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_one_out_inferer_forecaster_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetOneOutInfererForecasterNetworkRegretRequest,
                GetOneOutInfererForecasterNetworkRegretResponse,
            ),
            "/emissions.v8.QueryService/GetOneOutForecasterInfererNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_one_out_forecaster_inferer_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetOneOutForecasterInfererNetworkRegretRequest,
                GetOneOutForecasterInfererNetworkRegretResponse,
            ),
            "/emissions.v8.QueryService/GetOneOutForecasterForecasterNetworkRegret": grpclib.const.Handler(
                self.__rpc_get_one_out_forecaster_forecaster_network_regret,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetOneOutForecasterForecasterNetworkRegretRequest,
                GetOneOutForecasterForecasterNetworkRegretResponse,
            ),
            "/emissions.v8.QueryService/GetActiveTopicsAtBlock": grpclib.const.Handler(
                self.__rpc_get_active_topics_at_block,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetActiveTopicsAtBlockRequest,
                GetActiveTopicsAtBlockResponse,
            ),
            "/emissions.v8.QueryService/GetNextChurningBlockByTopicId": grpclib.const.Handler(
                self.__rpc_get_next_churning_block_by_topic_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetNextChurningBlockByTopicIdRequest,
                GetNextChurningBlockByTopicIdResponse,
            ),
            "/emissions.v8.QueryService/GetCountInfererInclusionsInTopic": grpclib.const.Handler(
                self.__rpc_get_count_inferer_inclusions_in_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetCountInfererInclusionsInTopicRequest,
                GetCountInfererInclusionsInTopicResponse,
            ),
            "/emissions.v8.QueryService/GetCountForecasterInclusionsInTopic": grpclib.const.Handler(
                self.__rpc_get_count_forecaster_inclusions_in_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetCountForecasterInclusionsInTopicRequest,
                GetCountForecasterInclusionsInTopicResponse,
            ),
            "/emissions.v8.QueryService/GetActiveReputersForTopic": grpclib.const.Handler(
                self.__rpc_get_active_reputers_for_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetActiveReputersForTopicRequest,
                GetActiveReputersForTopicResponse,
            ),
            "/emissions.v8.QueryService/GetActiveForecastersForTopic": grpclib.const.Handler(
                self.__rpc_get_active_forecasters_for_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetActiveForecastersForTopicRequest,
                GetActiveForecastersForTopicResponse,
            ),
            "/emissions.v8.QueryService/GetActiveInferersForTopic": grpclib.const.Handler(
                self.__rpc_get_active_inferers_for_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetActiveInferersForTopicRequest,
                GetActiveInferersForTopicResponse,
            ),
            "/emissions.v8.QueryService/IsWhitelistedGlobalWorker": grpclib.const.Handler(
                self.__rpc_is_whitelisted_global_worker,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedGlobalWorkerRequest,
                IsWhitelistedGlobalWorkerResponse,
            ),
            "/emissions.v8.QueryService/IsWhitelistedGlobalReputer": grpclib.const.Handler(
                self.__rpc_is_whitelisted_global_reputer,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedGlobalReputerRequest,
                IsWhitelistedGlobalReputerResponse,
            ),
            "/emissions.v8.QueryService/IsWhitelistedGlobalAdmin": grpclib.const.Handler(
                self.__rpc_is_whitelisted_global_admin,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedGlobalAdminRequest,
                IsWhitelistedGlobalAdminResponse,
            ),
            "/emissions.v8.QueryService/IsTopicWorkerWhitelistEnabled": grpclib.const.Handler(
                self.__rpc_is_topic_worker_whitelist_enabled,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsTopicWorkerWhitelistEnabledRequest,
                IsTopicWorkerWhitelistEnabledResponse,
            ),
            "/emissions.v8.QueryService/IsTopicReputerWhitelistEnabled": grpclib.const.Handler(
                self.__rpc_is_topic_reputer_whitelist_enabled,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsTopicReputerWhitelistEnabledRequest,
                IsTopicReputerWhitelistEnabledResponse,
            ),
            "/emissions.v8.QueryService/IsWhitelistedTopicCreator": grpclib.const.Handler(
                self.__rpc_is_whitelisted_topic_creator,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedTopicCreatorRequest,
                IsWhitelistedTopicCreatorResponse,
            ),
            "/emissions.v8.QueryService/IsWhitelistedGlobalActor": grpclib.const.Handler(
                self.__rpc_is_whitelisted_global_actor,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedGlobalActorRequest,
                IsWhitelistedGlobalActorResponse,
            ),
            "/emissions.v8.QueryService/IsWhitelistedTopicWorker": grpclib.const.Handler(
                self.__rpc_is_whitelisted_topic_worker,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedTopicWorkerRequest,
                IsWhitelistedTopicWorkerResponse,
            ),
            "/emissions.v8.QueryService/IsWhitelistedTopicReputer": grpclib.const.Handler(
                self.__rpc_is_whitelisted_topic_reputer,
                grpclib.const.Cardinality.UNARY_UNARY,
                IsWhitelistedTopicReputerRequest,
                IsWhitelistedTopicReputerResponse,
            ),
            "/emissions.v8.QueryService/CanUpdateAllGlobalWhitelists": grpclib.const.Handler(
                self.__rpc_can_update_all_global_whitelists,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanUpdateAllGlobalWhitelistsRequest,
                CanUpdateAllGlobalWhitelistsResponse,
            ),
            "/emissions.v8.QueryService/CanUpdateGlobalWorkerWhitelist": grpclib.const.Handler(
                self.__rpc_can_update_global_worker_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanUpdateGlobalWorkerWhitelistRequest,
                CanUpdateGlobalWorkerWhitelistResponse,
            ),
            "/emissions.v8.QueryService/CanUpdateGlobalReputerWhitelist": grpclib.const.Handler(
                self.__rpc_can_update_global_reputer_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanUpdateGlobalReputerWhitelistRequest,
                CanUpdateGlobalReputerWhitelistResponse,
            ),
            "/emissions.v8.QueryService/CanUpdateParams": grpclib.const.Handler(
                self.__rpc_can_update_params,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanUpdateParamsRequest,
                CanUpdateParamsResponse,
            ),
            "/emissions.v8.QueryService/CanUpdateTopicWhitelist": grpclib.const.Handler(
                self.__rpc_can_update_topic_whitelist,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanUpdateTopicWhitelistRequest,
                CanUpdateTopicWhitelistResponse,
            ),
            "/emissions.v8.QueryService/CanCreateTopic": grpclib.const.Handler(
                self.__rpc_can_create_topic,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanCreateTopicRequest,
                CanCreateTopicResponse,
            ),
            "/emissions.v8.QueryService/CanSubmitWorkerPayload": grpclib.const.Handler(
                self.__rpc_can_submit_worker_payload,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanSubmitWorkerPayloadRequest,
                CanSubmitWorkerPayloadResponse,
            ),
            "/emissions.v8.QueryService/CanSubmitReputerPayload": grpclib.const.Handler(
                self.__rpc_can_submit_reputer_payload,
                grpclib.const.Cardinality.UNARY_UNARY,
                CanSubmitReputerPayloadRequest,
                CanSubmitReputerPayloadResponse,
            ),
            "/emissions.v8.QueryService/GetTopicInitialInfererEmaScore": grpclib.const.Handler(
                self.__rpc_get_topic_initial_inferer_ema_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicInitialInfererEmaScoreRequest,
                GetTopicInitialInfererEmaScoreResponse,
            ),
            "/emissions.v8.QueryService/GetTopicInitialForecasterEmaScore": grpclib.const.Handler(
                self.__rpc_get_topic_initial_forecaster_ema_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicInitialForecasterEmaScoreRequest,
                GetTopicInitialForecasterEmaScoreResponse,
            ),
            "/emissions.v8.QueryService/GetTopicInitialReputerEmaScore": grpclib.const.Handler(
                self.__rpc_get_topic_initial_reputer_ema_score,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTopicInitialReputerEmaScoreRequest,
                GetTopicInitialReputerEmaScoreResponse,
            ),
            "/emissions.v8.QueryService/GetLatestRegretStdNorm": grpclib.const.Handler(
                self.__rpc_get_latest_regret_std_norm,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestRegretStdNormRequest,
                GetLatestRegretStdNormResponse,
            ),
            "/emissions.v8.QueryService/GetLatestInfererWeight": grpclib.const.Handler(
                self.__rpc_get_latest_inferer_weight,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetLatestInfererWeightRequest,
                GetLatestInfererWeightResponse,
            ),
            "/emissions.v8.QueryService/GetLatestForecasterWeight": grpclib.const.Handler(
