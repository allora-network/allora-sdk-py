...
from ....cometbft.abci import v2 as ___cometbft_abci_v2__
from ....cometbft.types import v2 as ___cometbft_types_v2__
...
class HistoricalInfo(betterproto.Message):
    ...
    header: "___cometbft_types_v2__.Header" = betterproto.message_field(1)
...
class ValidatorUpdates(betterproto.Message):
    ...
    updates: List["___cometbft_abci_v2__.ValidatorUpdate"] = betterproto.message_field(
        1
    )
