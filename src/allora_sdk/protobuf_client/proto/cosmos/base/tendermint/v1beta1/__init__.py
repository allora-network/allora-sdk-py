...
from .....cometbft.types import v2 as ____cometbft_types_v2__
...
class Block(betterproto.Message):
    ...
    data: "____cometbft_types_v2__.Data" = betterproto.message_field(2)
    evidence: "____cometbft_types_v2__.EvidenceList" = betterproto.message_field(3)
    last_commit: "____cometbft_types_v2__.Commit" = betterproto.message_field(4)
...
class Header(betterproto.Message):
    ...
    last_block_id: "____cometbft_types_v2__.BlockId" = betterproto.message_field(5)
    """prev block info"""
...
class GetBlockByHeightResponse(betterproto.Message):
    ...
    block_id: "____cometbft_types_v2__.BlockId" = betterproto.message_field(1)
    block: "____cometbft_types_v2__.Block" = betterproto.message_field(2)
