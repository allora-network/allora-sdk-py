...
# sources: cometbft/types/v2/block.proto, cometbft/types/v2/evidence.proto, cometbft/types/v2/params.proto, cometbft/types/v2/types.proto, cometbft/types/v2/validator.proto
...
class Vote(betterproto.Message):
    ...
    non_rp_extension: bytes = betterproto.bytes_field(11)
    """
    Non-Replay-Protected (NRP) vote extension provided by the application.
     Only valid for precommit messages.
    """

    non_rp_extension_signature: bytes = betterproto.bytes_field(12)
    """
...
class ExtendedCommitSig(betterproto.Message):
    ...
    non_rp_extension: bytes = betterproto.bytes_field(7)
    """Non-Replay-Protected vote extension data"""

    non_rp_extension_signature: bytes = betterproto.bytes_field(8)
